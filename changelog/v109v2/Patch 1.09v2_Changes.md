//------------------------------------------------------------------//
;;--------------BFME2 1.09v2 from 1.09.v1 Changelog ----------------;;
//------------------------------------------------------------------//
...
* Patch 1.09 — Version 1 Changelog
...
-RohanElvenWarrior armor set up to the average between 1.09 RohanElvenWarrior armor and MenOfDale armor.
...
-GondorTowerGuard +10% bonus against CAVALRY now includes GoblinSpiderling & Shelob.
...
-GondorKnight damage gains on level 2, 3, 4 reduced, now +5 from +10.
...
-Men House of Healing can now heal allied "Monster heros" such as ElvenEagles, MordorFellBeast, MordorWitchKing, Shelob.
-MenFortress House of healing extra-5% HERO purchase discount removed.
#### Structures. GondorStable
...
#### Structures. GondorBattleTower
-updated the bounty value of GondorBattleTower to 1/4 of 350 instead of 1/4 of 500.


### Men. Heroes:
#### Heroes. Gandalf
-Gandalf shield bubble bonus now 99% armor from 99999%. //this means ElvenMist or MoS debuff actually has a effect. (-25 debuff, -20 agresive stance = 54%)
-Gandalf shield bubble bonus duration 4500ms from 5000ms.
-Gandalf blast bonus on infantry removed from the wide arc. (kept on the narrow arc)//Note i wanted to do this change months ago but i coded it wrong so it had no effect.
-Gandalf shadowfax moved to level 3.
-Gandalf experience required for level 2 to 5 increased. (total experience required for lvl 6 is the same)
-Gandalf damage in the outer arc no longer applies +35% bonus against Elven Units.
-Gandalf the grey health now 4450 from 4700. (originaly 4300)
-Gandalf lighting FLAME damage halved. (Magic damage had been halved but FLAME was not)
-Gandalf mounted not being able to chase units in movement fixed.
-Gandalf WordOfPower set a damage TaperOff of 50%, from having 100% damage in 300 radius and 50% in 400 radius.
*Gandalf TheWhiteBonus recharge bonus now 80% from 75%. (all his spells take 5% longer to recharge)
*Gandalf TheWhiteBonus bonus no longer grants +200 HP.
-Gandalf WizardBlast & LightningSword now deals 1000% against TomBombadil from 100%/110% respectively.
-Gandalf WizardBlast damage in radius is now divided in two: 30% of total damage dealt in 135º Radius Arc and the 100% of the damage will be dealt in the traditional 75º arc, from 100% damage in 135º arc radius.
-Gandalf WizardBlast max (30% of total damage) now changes per level. 120 at level 1, 127 at level 5, 135 at level 8 (from 165 in 1.09 and 75 in vanilla) //played with 135 on all levels
-Gandalf WizardBlast knockback is slightly stronger and faster in 75 arc, to distinguish the fact it deals more damage in that area.
-Gandalf WizardBlast shockwave arc at level 1/4/8 now 100/115/130 from 110/110/110. (Played with 120/127/135)
-Gandalf WizardBlast 205% on infantry on 105.
-Gandalf WizardBlast now unlocks 10% more damage in 45º arc with a +105% bonus on infantry.
*Gandalf WizardBlast damage arc now 135 from 165. (Originally 75)
-Gandalf WizardBlast shockwave now matches with the extra damage. (135 shockwave arc from 75)
-Gandalf IstariLight now properly deals the 350% intended damage against Aragorn, instead of 300%. //Note AGAINST DwarvenGimli IT IS NOT FIXED IN PURPOSE now
*Gandalf IstariLight now deals 350% from 300% against Shelob.
-Gandalf IstariLight now deals 150% against Attack Trolls.
-Gandalf LightningSword now properly deals the 340% intended damage against Aragorn, instead of 220%. 
-Gandalf LightningSword FLAME damage against MordorMumakil now 35% from 100%. 
-Gandalf LightningSword MAGIC damage halved. (Remember Light sword now shoot 2 per burst)
-Gandalf LightningSword now hits 2 different units per burst. (damage untouched yet)
*Gandalf LightningSword now deals 170% against Shelob from 110%.
-Gandalf LightningSword now deals 80% against STRUCTURES, from 100%. (note that LightningSword damage was improved from 300 to 500 on patch 1.07. So this would equal to 400 damage against buildings.)
#### Heroes. Aragorn
-RohanOathbreaker to deal 75% against Aragorn, from 100%.  //played with 25.
-Aragorn athelas unpacktime 800ms from 951.
-Aragorn blademaster unpack 800ms from 1000ms
-AragornSword set a taperoff of 65%.
-Aragorn sword damage gains are now multiplicative. Level1 to level 10 respectively now 312/483 from 312/512. 
-Aragorn sword blademaster HERO damage gains are now multiplicative. Level1 to level 10 respectively now 312/483 from 250/350. //Played with 250/450
-Aragorn sword blademaster MAGIC damage is only enabled at level 5 when Aragorn gains anduril. Causing a different damage FX.
-Aragorn sword standard/BladeMasterMode now deals 85% against STRUCTURES, from 100%.. (note he deals 77% against Fortress)
-Aragorn BladeMaster. DamageTaperOff of 65% min.//aka, 35% damage loss based on distance.
-Aragorn is no longer penaltied by -15% against MordorWitchKing.
-Aragorn BladeMaster damage bonus now +50% from +100%.
-Aragorn standard sword/BladeMaster now deals 100% against STRUCTURES, from 125%. (against fortress it still deals 77%)
-Aragorn buildtime now 50 from 45.
-Aragorn BladeMaster duration reduced to 25s, from 30s
-Aragorn starting BladeMaster now has to play an animation. Time to unpack it set to 1000ms. // played with 1100
-Aragorn normal damage & BladeMaster mode against Fortress now 77% from 85%.
-Aragorn athelas no longer heals crebain/bats.Flyers stay 110%. Galadriel, ElvenTreebeard stay 110%. Sauron 220% from 110%.
-Aragorn cast Athelas now has to play an animation. Time to unpack it set to 951ms.
...
#### Heroes. Boromir
-Boromir TrainAllies radius cursor now 140 from 100.
-Boromir TrainAllies actual radius now 140 from 150.

-Boromir experience required for level 5 reduced, from 260 to 160.
-Boromir experience required for level 7 reduced, from 650 to 750.
-Boromir Leadership range now 225 from 275. (originally 200)

-Boromir sword chances to knockback Gloin now 20% from 15%. (Originally 25%) //For comparison, note that since patch 1.08 Boromir chances against Lurtz were restored to 25%.
-Boromir sword knockback area now less wider against trolls. Metaimpact arc now 40 from 120.
-Boromir sword move-attack glitch fixed.(which implies 1/3 of second shorter delay between shots for onhost players). real delaybetweenshoots set to the average between the glitch speed up and the unforced speed. PreAttackDelay, DelaybetweenShoots and Firing duration now 733, 933, 933 from 733, 766, 1100 respectively.
#### Heroes. Theoden
-Theoden Health now 2600 from 2800.

-Theoden Leadership moved to level 2. (Avoids game ending in 2 minutes because someone rushes 2 rohirrims with RC + Theoden Leadership)
-Theoden Leadership now grants StackyDamageLeadership, instead of BasicDamageLeadership.

-Theoden TrainAllies radius cursor now 100 from 100.
-Theoden TrainAllies actual radius now 100 from 150.
-Theoden TrainAllies animations not always playing if mounted.

-Theoden sword mounted now deals a +15% bonus against MordorMountainTroll
-Theoden mounted sword penalty against STRUCTURES now include fortress. (deals 77%)
-Fixed Theoden dismounted and mounted sword animation not matching damage and playing attack FX's before moving sword.

-Theoden respawn at level 7 now cost 880 with 165 buildtime. (remember the formula was 55secs the first 4 levels, 110 the next 3, and 165 the last 3)
-Theoden respawn time formula now based on 45 seconds from 55. (buildtime is 40)

-Theoden GloriousCharge skipabble animation fixed. Now propelry has to unpack for 1 second before becoming white.
-Multiple GloriousCharges wont stack the FXs causing lag.
-Theoden GloriousCharge armor bonus restored to 99 from 80%. ;;=GloryCharg=;;
-Theoden GloriousCharge range now 250 from 200. ;;=GloryCharg=;;
-Theoden GloriousCharge cooldown now 210 from 270. (originally 240) ;;=GloryCharg=;;
-Theoden GloriousCharge now provides immunity to fear
#### Heroes. Faramir
-Faramir TrainAllies ability renamed from "Captain of Gondor" to "Prince of Ithilien"; now trains only archers.
-Faramir TrainAllies moved to level 5 from level 7.
-Faramir TrainAllies radius cursor now 120 from 100.
-Faramir TrainAllies actual radius now 120 from 150.
-Faramir experience required from lvl 2 to 6 reduced.
-Faramir Leadership moved to level 7 from level 6.
-Faramir shroud reveal is now penaltied behind him by -40% and -30% on his sides. (VisionRear 60%, VisionSides 70% from 100% both)
-Faramir sword damage gains are now multiplicative. Level1 to level 10 respectively now 200/310 from 200/300. 
-Fixed Faramir sword/mounted animations not matching hit FX, speeded up and added proportional delay between shots.
-Faramir bow now deals 95% against MordorMumakil, from 100%.
-Faramir bow now deals 110% against DwarvenBattleWagon.
-Faramir bow damage now 160 from 150.
-Faramir bow damage gains are now multiplicative. Level1 to level 10 respectively now 165/256 from 150/250. //Played with 160/260 (Originally 150/250)
-Faramir WoundingArrow terror duration against trolls increased to 7 s from 5 s.
-Faramir WoundingArrow now deals 140% against MordorMumakil. (consider a normal arrow deals more damage when leveled up due different damage type.) 
-Faramir WoundingArrow +50% bonus against Trolls now also include MordorAttackTroll.
-Faramir WoundingArrow not dealing 10% to STRUCTURES and MACHINES since 1.06 fixed.
-Faramir WoundingArrow now deals 120% against DwarvenBattleWagon.  //Which is 1311 damage instead of 1140 against DwarvenBattleWagon. (THEY HAVE 3K HP)
-Faramir WoundingArrow now deals 118% to GoblinDrogoth, from 125%  (originally 100%)
-Faramir WoundingArrow damage gains are now multiplicative. Level1 to level 10 respectively now 500/775 from 600/700. //Played with 600/800
-Faramir WoundingArrow no longer knockbacks monsters. (GoblinCaveTroll)
#### Heroes. Eomer
-Fixed Eomer Leadership affecting DwarvenBattleWagon.
-Eomer outlaw Leadership no longer affect heroes. (Matches with Lurtz Pillage)
-Eomer mounted sword penalty against STRUCTURES now include fortress. (deals 77%)
-Eomer damage gains are now multiplicative. Level1 to level 10 respectively now 150/233 from 150/250. 
-Eomer SpearThrown damage gains are now multiplicative. Level1 to level 10 respectively now 380/589 from 400/500. //Played with 400/600
-Eomer SpearThrown now has a +15% damage bonus against MordorMountainTroll, Drummer Trolls and AttackTrolls, from only GoblinCaveTroll.
-Fixed Eomer sword animation not matching damage and playing attack FX's before moving sword. PreAttackDelay, DelaybetweenShoots and Firing duration now 540, 550, 550 from 150, 850, 1000 respectively. .
-Eomer SpearThrown reload time now 45 seconds from 35.
-Fixed Eomer attack moving animation while turning to the sides.
#### Heroes. Eowyn
-Eowyn health restored to 2800 from 3000. 
-Eowyn bounty value updated to its buildcost. Now 375 from 450.
-Eowyn experience required increased on all levels.
-Eowyn spear attack animation delayed damage fixed. Animation speeded up to properly match the damage per second relationship.
-Eowyn Smite damage gains are now multiplicative. Level1 to level 10 respectively now 515/800 from 600/700.
-Eowyn Smite damage bonus now affects all heroes, from just Evil ones.
-Eowyn Smite no longer cancels Disguise.
-Eowyn Disguise having no attack moving, ShieldMaiden or Smite animations fixed.
-Eowyn Disguise splash damage set a TaperOff of 65%.
-Eowyn Disguise moved to level 3 from level 4.
-Eowyn Disguise effect redesigned: Now she looks like a Eowyn for every player perspective with a simple disguised model and horse (brown horse).
-Eowyn Disguise no longer cancels ShieldMaiden.
-Eowyn Disguise now forbides Eowyn to dismounted, untill she toggles off the disguise.(Avoids a hardcoded visual bug since disguise doesn't get canceled properly)
-Eowyn Disguise spear attack speed is now the same than standard.
-Eowyn spear attack Standard/Disguised damage gains are now multiplicative. Level1 to level 10 respectively now 280/279 from 280/380.
-Eowyn spear attack Standard/Disguised damage now set to 180/100, from 150/200 respectively.
-Eowyn spear attack Standard/Disguised damage now deals 72%/36% against STRUCTURES, from 100%/40% respectively.
-Eowyn spear attack Standard/Disguised damage now deals 72%/36% against fortress, from 87%/40% respectively.
-Eowyn spear attack Standard/Disguised damage now deals 100%/50% against heroes, from 120%/90% respectively. 
-Eowyn spear attack Standard/Disguised damage now deals 100%/100% against monsters, from 120%/100% respectively.
-Eowyn ShieldMaiden trigger sound re-enabled.
-Eowyn ShieldMaiden deceleration bonus now also affects her self.
-Eowyn ShieldMaiden no longer cancels disguise.
-Eowyn ShieldMaiden FX no playing while mounted fixed. 
...
#### Spellbook. RohanRohirrimSummoned.
...
-ElvenLorienWarrior sword now deals 90/67.5% against Gloin, from 100%/75%.
-ElvenLorienWarrior sword now deals 90/67.5% against Dain, from 100%/75%.
...
#### Units. ElvenMirkwoodArcherMirkwood:
...
-ElvenEnt AutoHeal amount reduced to 27 from 40. 
...
ElvenEntSummoned
-ElvenEntSummoned duration now 105 seconds from 90. (Originally 120)
...
-ElvenTreebeard AutoHeal amount reduced to 40 from 50. 
...
-Aflamed ElvenTreebeard damage amount now 40 from 30. (AutoHeal no longer counters it) (ElvenEnt are 30 still) //played with 60
#### Heroes. ElvenHaldir.
...
-ElvenHaldir GoldenArrow now plays a unpacking sound, like Faramir WoundingArrow. So player can know when he's gonna shoot gold arrow and switch to def stance.
...
-ElvenHaldir GoldenArrow HERO_RANGED damage set to deal 70% against Gandalf.
-ElvenHaldir GoldenArrow HERO_RANGED damage set to deal 80% against ElvenEagles.
-ElvenHaldir GoldenArrow HERO_RANGED damage set to deal 65% against ElvenLegolas Faramir Wormtongue.
-ElvenHaldir GoldenArrow SPECIALIST damage set to deal 33% against Elrond DwarvenGimli Saruman ElvenHalddir Dain Aragorn ElvenThranduil ElvenEagles GoblinDrogoth
...
-ElvenLegolas Bow now deals 90% against all isen heroes. Played with 90% against Saruman only.
-ElvenLegolas bow now deals 90% against Saruman.
...
-ElvenThranduil ThornOfVengaence POISON to also deal 80% against DwarvenGimli Saruman.
...
-ElvenThranduil ThornOfVengaence HERO damage set to deal 80% agaisnt Gloin Dain DwarvenGimli.
-ElvenThranduil ThornOfVengaence POISON damage set to deal 150% agaisnt MordorWitchKing.
-ElvenThranduil ThornOfVengaence POISON damage set to deal 200% agaisnt Gandalf.
...
*Elrond speed reduced to 68, from 70. (Originaly 65)
*Elrond ElvenGrace now heals infantry, CAVALRY and also monsters.
*Elrond ElvenGrace now provides +15% additive Health Points and 25% bonus experience for 12s to infantry, CAVALRY, and monsters(not heroes)
*Elrond ElvenGrace now provides resistance to fear and terror for infantry, CAVALRY, and monsters for 12s
-Elrond ElvenGrace autoability adapted to the new design: it will work when Elrond sees at least 20 infantry allied units or 3 heroes.
-Elrond ElvenGrace bonus (not heal)  radius 220 from 250.
-Elrond ElvenGrace unpacktime 1000ms from 1133.
-Elrond ElvenGrace bonus now forces a celebrating animation.
*Reworked Elrond ElvenGrace to be less effective on heroes and more effective on hordes and monsters
-Elrond ElvenGrace radius restored to 250 from 300. // It's big enough even for the "army buff design". 
*Elrond ElvenGrace heal amount to heroes reduced from 1000 to 750. //played with 650.
-Elrond ElvenGrace no longer affect flyers.
-Added new Elrond cast ElvenGrace animation. Time to unpack it set to 1133 ms.
-Elrond sword now deals 85% to STRUCTURES, from 100%.
-Elrond sword damage against Heroes reduced to 150% from 200%. (Except against MordorWitchKing)
-Fixed Elrond sword animation not matching damage and playing attack FX's before moving sword. PreAttackDelay, DelaybetweenShoots and Firing duration now 500, 900, 700 from 50, 1200, 1200 respectively.
-Added Elrond sword moving attack animation.
-Elrond Leadership range now 300 from 350. (Originally 200)
*Elrond Tornado lifetime now 19s, from 25s. //played with 17s.
*Elrond Tornado speed now 47 from 45
...
-Elrond Farsight bonus now forces a alert animation.
-Fixed Elrond Farsight not castable on water.
*Elrond Farsight no longer gives a range bonus to units
*Elrond Farsight now gives 27.5% bonus shroud clearing to infantry, CAVALRY, MACHINES and monsters(not heroes). Duration is 25s
-Added new Elrond cast Restoration animation. Time to unpack it set to 1128 ms.



### Elves. Spellbook:
#### Spellbook. ElvenFarsight:
...
#### Units. Guardian
-Guardian SiegeHammer and ForgedBlades are now imposible to glitch the buttons and purchase both upgrades.
-Guardian now deals 90% to ElvenMallorn.
-Fixed summoned Guardian (From Dain) having SiegeHammers available.
-Guardian now deals 90% against MordorFighter from 85%.
-Guardian armor against CAVALRY now 200%/130% from 200%/120%. (other factions are 150%/120%)
-Fixed Guardian with ForgedBlades gaining twice damage as any other unit.
-Guardian now gains +5% speed at level 3, 5, 7 and 10. (Stacking manage to reach to 121% of their original speed, which is Phalanx speed)
-Guardian now deals 90% to IsengardFurnace from 100%.
-Guardian charge bullrush now displays the animation originaly created for it.
-DwarvenSiegeHammers equip per unit buildtime upgrade now 17 seconds from 10. (Originally also 10 but bt2dc was 25)
-Guardian basic/upgraded now deals 80%/160% to GoblinSpiderling, from 100%/200%.  //Wasn't affecting ForgedBlades before//
-Guardian SiegeHammers damage now 68 from 56. (Originally 80) Damage against Fortress now 55% from 66%. (almost proportional)
-Guardian now deals 95% from 100% against GondorSoldier, Gondor GondorTowerGuard, MordorCorsair, MordorEasterling.
-Guardian-15% penalty against goblin cave removed. (Caves now have a proper barrack armor, thus stronger to swords)
#### Units. Phalanx
-Phalanx armor to FLAME now 100%/65% from 100%/75%. (standard/HeavyArmor resepectively.
-Phalanx armor to MAGIC now 100%/65% from 100%/75%. (standard/HeavyArmor resepectively.
-Fixed Phalanx now using attack moving animation.
-Phalanx armor against structural damage now 100%/25% from 100%/20%.
-Phalanx damage now 45/80 from 45/90.
-Phalanx now deals 123% against GoblinCaveTroll. from 110%. //played with 113%.
-Phalanx now deals 90% against ElvenHaldir.
-Phalanx weapon basic/upgraded now deals 73%/73% to MordorMountainTroll, from 100%/100%.
-Phalanx armor against CAVALRY_RANGED now 30%/15% from 20%/10%.
-Phalanx now deal 120%/120% to MordorMumakil from 100/100%. (normal, forged blade respectively)
-Phalanx now deal 113% to GoblinCaveTroll, from 110%

#### Units. AxeThrower
-AxeThrower damage gains now 7, 7, 7, 7, 3, 3, 3, 3, 5 from 10 10 10 10 5 5 5 5 10.
-AxeThrower from RoyalGuard now use the damage gains from a normal axe thrower. (which means +45 damage instead of +70)
-Fixed AxeThrower attack/bombard animation speed, now properly matches the delay untill throwing the axe.
-AxeThrower bombard random preattack delay now 200 from 0. (Normal weapon is 200 too)
-AxeThrower now deals 120% against MordorFighter, IsengardFighter, ElvenLorienWarrior.
-AxeThrower armor against crush now 185%/150% from 185%/140%. (Originally 175%/140%)
-AxeThrower damage now 24/48 from 24/42. //Consider damage gains have been weworked.
-AxeThrower damage gains are now separated from good troops: damage gains now 7 5 5 10 3 3 3 10, from 10 10 10 10 5 5 5 5 10. (total +45 from +70) //consider base damage is just 24.
-AxeThrower now deals 125% against ElvenHaldir.
-AxeThrower bombard attack HoldAfterFiringDelay now matches FiringDuration.
-Fixed AxeThrower PreAttackRandomAmount desnyching the attack animations after a constant attack. Set to 200 from 400. (real delay between shoots is barely affected)
-AxeThrower now deals 85%/85% against STRUCTURES, from 85%/100%. (basic/upgraded respectively)
-AxeThrower now deals 100%/135% against Infantry, from 100%/100%. (basic/upgraded respectively). (Doesn't include Heroes, Archers nor SpiderSpiderLingLairs)
-AxeThrower now deals 75% from 80% against GondorArcher.
-AxeThrower now deal 155% to GoblinCaveTroll, from 150%
-AxeThrower now deals 95% from 100% against MordorHaradrimArcher.
-AxeThrower damage against Crebain/Bats now 150/135% from 135%/100%. (I had given this +35% for 1.09 but it is not enough, they take 3 hits to kill it, which is like 7.5 seconds to take it down. While IsengardUrukCrossbow would end it in two volleys in 4 secs)
-AxeThrower now deal 35% to Fortress expansions, from 50%.
-AxeThrower bombard now properly deals half damage than standard attack against STRUCTURES.


#### Units. MenOfDale
-MenOfDale +15% bonus against Monsters now include GoblinSpiderling.
-Fixed MenOfDale black arrows dealing 1% against DwarvenBattleWagon.
-MenOfDaleSummoned E command selection no longer selects non-summoned ones.
-MenOfDale UPGRADED WITH FIRE ARROWS PIERCE/FLAME damage now 52/50 from 50/50.

#### Units. DwarvenBuilder
...
#### Units. Demolisher
-Demolisher armor against SIEGE now 80%/50% from 40%. //played with 70%/35%.
-Demolisher armor against CRUSH now 50%/35% from 1%/1%. Nothing can actually crush it but spells like SummonedWatcher summon deals crush damage.
-Demolisher armor against SIEGE now 70%/35% from 40%/20%.

#### Units. DwarvenCatapult
...
#### Units. DwarvenBattleWagon
-fixed DwarvenBattleWagon MenOfDale not shooting in movement.
...
-DwarvenBattleWagon AutoHeal FX now different from hearth healing fx.
-DwarvenBattleWagon level 3 AutoHeal now needs 15 seconds to start, from 10. (At level 5 it keeps being 10 secs)
...
-DwarvenBattleWagon now deals 80% against Faramir.
-DwarvenBattleWagon now deals 80% against ElvenLegolas.
-DwarvenBattleWagon AutoHeal won't work if DwarvenBattleWagon is under attack. ////"getting attacked doesn't necesarely mean getting damaged, sadly
-DwarvenBattleWagon level 3 AutoHeal amount now 15 from 0. /7played with 20 //played with 25.
-DwarvenBattleWagon AutoHeal moved to level 3, from 5.
-DwarvenBattleWagon level 5 AutoHeal now 30 from 38. //played with 38.
-DwarvenBattleWagon upgraded with BannerCarrierPhalanx now occupy 8 extra commandpoints.
-DwarvenBattleWagon BannerCarrierPhalanx damage now matches with the damage of two Phalanx. Damage now 90 from 75. Damage penaltied by 10% against STRUCTURES.
...
-DwarvenBattleWagon AxeThrower can now be dodged. (Like 1.06)
-DwarvenBattleWagon AxeThrower weapon speed increased to 250 from 180.
-Fixed DwarvenBattleWagon AxeThrower projectiles following it's targets all over the map.
-DwarvenBattleWagon AxeThrower damage against STRUCTURES now 80% from 100%.
-DwarvenBattleWagon AxeThrower now display forged blade before throwing it.
-DwarvenBattleWagon upgraded with AxeThrower now occupy 8 extra commandpoints.
-DwarvenBattleWagon AxeThrower weapon speed increased to 215 from 180. //played with 250
-DwarvenBattleWagon AxeThrower passsenger damage now 60 from 65.
*DwarvenBattleWagon AxeThrower now deal 75% damage against pikes, from 100%.
-DwarvenBattleWagon Hearth AxeThrower cost now 350 from 300.
-DwarvenBattleWagon upgraded with MenOfDale now ocupy 12 extra commandpoints.
-DwarvenBattleWagon MenOfDale damage now 150 from 190. Damage Scalars against PIKEMEN, Builders, Heroes, GoblinCaveTroll and Flyers updated proportionaly to have no effect.
-DwarvenBattleWagon MenOfDale now deals 78% against GoblinCaveTroll, from 65%. (originally 100%)
...
-DwarvenBattleWagon MenOfDale/AxeThrower/Phalanx shroud reveal reduced at the sides and from behind. (Shroud revealing is now like DwarvenBattleWagon without upgrades)
...
-DwarvenBattleWagon now receives experience from kills of MenOfDale, AxeThrower or Phalanx upgrades.
-DwarvenBattleWagon armor DodgeRate now 30% from 15%.
-Fixed DwarvenBattleWagon MenOfDale and AxeThrower shooting through STRUCTURES.
...
### Dwarves. Heroes:
#### Heroes. Gimli:
-DwarvenGimli BasicAxe/SlayerMode/AxeThrow is now penaltied by 5% against Gandalf.
...
-DwarvenGimli BasicAxe now deals 90% to Saruman, from 100%. 
-DwarvenGimli BasicAxe now deals 95% to Aragorn, from 100%.
...
-DwarvenGimli LeapAbility now deals 100% from 35% against Phalanx.
...
-DwarvenGimli SlayerMode now has a 12% penalty against Aragorn. 
-DwarvenGimli SlayerMode now has an 80% chance to knockback heroes, from 100%
#### Heroes. Dain:
-Dain pig crush deceleration set to 8%. (Theoden is 30%, MordorBlackRider is 5%)
-Dain pig minimun crush velocity set to 45% (Theoden is 50%, a MordorBlackRider is 56%)
-Dain pig armor set to normal mounted HERO.
-Dain pig crush knockback force set to 65. (Theoden is 40)
-Dain pig crush knockback height multiplier set to x1.12. (Theoden is 1x)
-Dain pig mount set to level 8.
-Dain pig mount unpack time set to 2500. (Theoden is 2000)
-Dain experience required for level 2 to level 6 now 45 90 135 270 440. (From 40 80 120 170 250).
-Added Dain MightyRage to AI.
-Dain StubornPride range 225 from 250. originaly 200
-Dain health restored to 2700. //played with 2900.
-Dain armor against PIERCE restored to 17% from 19%.
-Fixed Dain RoyalGuard hordes not showing veterancy pip.
-Dain MightyRage bonus now forces a taunting animation.
-Dain new ability at level 6: ride a pig. Crush settings like ElvenThranduil elk. Armor like Sharku (i forgot to push it tho). Damage like Theoden mounted. Mount time generic, like Eomer. 
-Dain level 6 experience needed increased to 350 from 250. (total experience required for lvl 7 woul be the same)
-Dain respawn cost updated to its actual build cost. (From based on 1500 to based on 1800)
-Dain experience required for level 10 now 1530 from 1700. (this is same as 1.06)
-Dain health now 2900 from 2700.
-Dain axe now shares the penalties of Gloin axe. 50% against fortress, (from 80%, played with 65%), and 80% against MordorBlackRider.
-Dain nwo take 33% CAVALRY from 25%.
-Dain nwo take 25% URUK from 33%.
-Dain nwo take 40% SPECIALIST from 50%. //played with 45%
-Dain axe now deals 80% against GoblinCaveTroll.
-Dain armor now takes 19% PIERCE from 17%.
-Dain armor now takes 45% SPECIALIST from 50%.
-Added new Dain cast MightyRage animation. Time to unpack it set to 1150 ms. (played with 1300, i dont mind 1300 but we speeding up animations for lazy noobs)
-Added new Dain summoning RoyalGuard animation. Time to unpack it set to 1300 ms + 1000 ms of Dwarves delay. (From unpack 0 ms + 2000 ms of dwarves delay)
...
-Dain RoyalGuard reload time reverted to 180 seconds, from 200.
-Dain StubornPride moved to level 6 from level 7.
-Dain MightyRage duration now 35 seconds from 30.
-Dain MightyRage now properly grants a 25% shroud reveal bonus for allied units as intended in previous patch.
-Fixed Dain StubornPride icon pressable
#### Heroes. Gloin:
-Fixed Gloin ShatterHammer damaging flyers.
-Gloin Oathbreaker stun time now 6 secs from 5.
-Gloin attack range now 15 from 11.5. //Considering Lurtz sword is 15 range, this explains why crippled Gloin sometimes can't defend himself from Lurtz. Other heroes are 20 range also.
-Gloin ShatterHammer max/min damage now 1100/435. //played with 1000/435, 1000/350
-Gloin Shake Foundations no longer one-shoots summoned towers. Now leaves them with black health bar one axe hit left.
-Gloin ShatterHammer. Damage/DamageTaperOff now 1000/435. //played with 1000/350.
-Gloin axe now deals 80% against GoblinCaveTroll.
-Gloin SLAM now deals 80% to GoblinCaveTroll, from 100%. //played with 85%
-Gloin Slam now deals 85% against GoblinCaveTroll.
-Gloin Slam minimun start ability range now 15 from 5.
-Gloin ShatterHammer can now also knock-back 3k heroes but in half of its shockwave radius.
-Gloin ShatterHammer. DamageTaperOff of 35%. //aka, can lose 65% damage based on distance.
-Gloin ShatterHammer damage restored to 1000 from 1100. //played with 875 and confusingn radius values.
-Gloin ShatterHammer now deals zero damage against Army Of the Dead(previously it could kill it)
-Gloin ShatterHammer can now stun(prevent movement) to Army Of the Dead for 5s
-Gloin ShatterHammer shockwave reduced from 500 to 400. (not damage)
-Gloin ShatterHammer FX improved.
-Gloin ShatterHammer now has a new cast preview image
...
-Gloin Shake Foundations now leaves level 3 farms/ElvenMallorn/mine/GoblinTunnel/shlaugerhouses/furnaces in red health bar, one hit left to fall down.
-Gloin can no longer be forced to attack before Shake Foundations animation completes. 



### Dwarves. Structures:
#### Structures. DwarvenFortress.
...
-DwarvenSiegeKegs can now heal allied "Monster heros" such as ElvenEagles, MordorFellBeast, MordorWitchKing, Shelob.
...
#### Structures. DwarvenForgeWorks
-DwarvenBattleWagon/DwarvenCatapult/Demolisher inmunity while spawning now 5500 from 6000.
...
#### Structures. DwarvenHallExpansion
...
-DwarvenCitadel Spawn damage now 345/ max/min. From 250/250.
...
-SpellBookSummonMenOfDale
-MenOfDaleSummoned lifetime 145 seconds from 135. //played with 150. (Originaly 180)
#### Spellbook. DwarvenRallyingCall
...
#### Spellbook. SpellBookDwarfRichess
...
-MordorMumakil ChargeAttack now deals 1200% against Gandalf and MordorWitchKing, from 1000%:
...
*MordorHaradrimArcher can now purchase fire arrows upgrade. FLAME damage set to 500, like MenOfDale.
...
-MordorGrond can now begin an AutoHeal after 2 minutes outside battle and will heal 500 hp each 2 seconds. (Total health 42000) (do the calc urself to calc, it's around 4.5 min)
...
-MordorMountainTroll GrabTree/GrabOrc command not working while moving or attacking is now fixed. Scan radius reduced since it's now 100% receptive.
-MordorMountainTroll AutoHeal now begins in level 2 healing 27 HP per second, then in level 5 it heals 40 HP per second. (From 40 hp per second in level 3 and gaining +3 in levels 5 6 7 8 9 10)
-MordorMountainTroll AutoHeal level can now be told by portrait tooltip (Basic on lvl 2 & Advanced in level 5).
...
-MordorMountainTroll CrushAttack damage now 10 from 30. (but it will be increased by leveling up. a total of 50% in lvl 10)
-MordorMountainTroll CrushAttack radius now 5, from 10. (Does not include MordorFighter and GoblinFighter)
-MordorMountainTroll CrushAttack now uses the damage scalars from MordorBlackRider crush: 135% against infantry but not archers. 142% to Guardian.
...
-MordorMountainTroll PunchAttack now freezes him for 400 milliseconds in order to prevent hit and move glitch.
...
-MordorMountainTroll ClubSwingAttack now freezes him for 500 milliseconds in order to prevent hit and move glitch.
...
-MordorMountainTroll armor against PIERCE now takes 47% damage, from 50%.
-MordorMountainTroll armor against SPECIALIST now takes 123% damage, from 130%.
-MordorMountainTroll armor against CRUSH_REVENGE now takes 28% damage, from 33%. Originally 100%.
-MordorMountainTroll armor against SLASH/URUK now takes 17% damage, from 13%/15% respectively.
-MordorMountainTroll armor against CAVALRY now takes 40% damage, from 30%.
-MordorMountainTroll armor against HERO now takes 110% damage, from 100%.
-MordorMountainTroll armor against CRUSH_REVENGE now takes 35% damage, from 33%. //played 28, and 33 based on higher health. 
--DrummerMordorDrummerTroll
-MordorDrummerTroll damage gains are now multiplicative (+5% more damage per level). This means the damage gains for ClubSwingAttack weapons are no longer design breaking. (For example: with additive damage, a lvl 10 GoblinCaveTroll had exactly +50% more damage for PunchAttack and ShoulderAttack, but ClubSwingAttack/bash with tree would have +200% more damage. Breaking whatever scalars one carefuly makes for early game)
...
#### Units. MordorAttackTroll
-MordorAttackTroll damage gains are now multiplicative (+5% more damage per level). This means the damage gains for ClubSwingAttack weapons are no longer design breaking. (For example: with additive damage, a lvl 10 GoblinCaveTroll had exactly +50% more damage for PunchAttack and ShoulderAttack, but ClubSwingAttack/bash with tree would have +200% more damage. Breaking whatever scalars one carefuly makes for early game)
...
-MordorAttackTroll ClubSwingAttack now freezes him for 500 milliseconds in order to prevent hit and move glitch.
...
#### Spellbook. MordorSpellBookRainOfFire
...
#### Spellbook. MordorEyeOfSauron
-MordorEyeOfSauron reload time now 135s from 120s. (Originally 180s)
-MordorEyeOfSauron Leadership set to High Tier Heroe Leadership. Therefore; does not stack with Aragorn/Dain/Elrond because it's the same Leadership, and now on it is resistant to simple debuff.
...
-MordorMouthOfSauron EvilEye now properly deals +15% damage bonus against DwarvenGimli and Aragorn, as intended in 1.09v1.00.
...
#### Heroes. WKMordorWitchKingMounted
...
#### Structures. MordorSlaughterHouse
-MordorSlaughterHouse armor now takes 50% CAVALRY from 45%.
#### Structures. MordorSiegeWorks
...
#### Units. IsengardIsengardBerserker
-Fixed IsengardBerserker not dealing 85% to heroes and fortress as intended in 1.09.
#### Units. IsengardFighter
-IsengardFighter damage against Guardian now 92%/180% from 100%/200%(Standard/forgedBlade respectively). //played with 90%/200%.//played with 90%/180%
...
-IsengardFighter damage against Gloin now 80%/120% against Gloin (from 100%/150%)
...
#### Units. IsengardPikeman
-IsengardPikeman -10% on Dain.
...
#### Spellbook. IsengardDragonStrike
...
-IsengardExcavations can now heal allied "Monster heros" such as ElvenEagles, MordorFellBeast, MordorWitchKing, Shelob.
...
#### Spellbook. IsengardMineLauncher
...
### Isengard. Heroes:
#### Heroes. Sharku
-Fixed Sharku Leadership affecting DwarvenBattleWagon.
-Sharku health 2350 from 2300. //played with 2400. /nothing as gud as averages.
-Sharku damage now 260/370 (lvl 1 to lvl 10), from 270/370. //played with 270/384
-Sharku man eater ability moved to level 6 from 8.
-Sharku man eater reworked: after throwing the body of the target, Sharku will start a heroe mode ability, turning red like Lurtz.
-Sharku not being able to chase units in movement fixed.
-Sharku now deals 110% to GoblinCaveTroll from 100%. /played with 130%.
-Fixed Sharku man eater autoability targeting heroes.
-Sharku damage gains are now multiplicative. Level1 to level 10 respectively now 270/384 from 270/380. //played played 270/4185
-Sharku damage gains are now multiplicative, instead of additive. Which means his splash damage will always be a relationship of 100% max 65% min.
-Sharku man eater reload time now 130 seconds from 90s.
-Sharku BloodHunt Leadership no longer stack with HighTier HERO Leadership.
-Sharku man eater bonus now 35% armor +50% damage and 50% crush deceleration, from 50% aromr 50% damage.
-Sharku man eater grabbing a unit and not releasing bug fixed. 
-Sharku man eater failing to grab a unit but firing the modifier anyways fixed; now targets will properly be eaten.
-Sharku man eater starting cooldown before any effect fixed. Now recharge begins once Sharku is healed and in HERO mode.
- Sharku bloodhunt moved to level 3 from level 4.
-Sharku now takes 77.7% from CRUSH_REVENGE, from 100%. //Just like Shelob
-Sharku Sword now have a +30% bonus against Trolls.
-Sharku attack weapon. DamageTaperOff of 65% min. (From 270/135 HERO damage in 0/11 radius). //Kind of means 15% less damage lost in large area, when it was lossing 50% before.
-Sharku tame the beast required rank tooltip updated.
-Sharku HP now 2400 from 2300.
-Sharku Tame the Beast now plays an animation while its unpacking.
#### Heroes. Lurtz
-Lurtz: fixed all languages tooltips not indicating carnage needs level 2.
-Lurtz SwitchWeaponOnCloseRangeDistance 20 from 40.
-Lurtz cripple duration against ElvenThranduil restored to 1.09; 20 secs. //played with 15 16.
-Lurtz carnage now deals 50% against DwarvenBattleWagon from 100% //played with 75%.
-Lurtz cripple strike duration +1 second for any heroe. (as compensation for my sexy carnage delays)
-Lurtz carnage now deals 70% against monsters, excluding MordorMumakil.
-Lurtz Bow now deals 90% against DwarvenBattleWagon.
-Lurtz carnage now deals 75% against DwarvenGimli, from 87%. (Originally 100% obviously)
-Lurtz carnage set a taperoff of 65%.
-Lurtz melee 30 from 150. HERO from crush. 
-Lurtz shroud reveal is now penaltied behind him by -40% and -30% on his sides. (VisionRear 60%, VisionSides 70% from 100% both)
-Lurtz carnage armor bonus restored to 20% from 10%. (note that unpack carnage is pretty gey in beta, and carnage is also nerfed where it is necesary)
-Lurtz carnage radius reduced to 1.06: 15 radius instead of 20. Yet, damage radius remain 20 against Goblins, Marauders, SpiderRiders and Orcs.
-Lurtz carnage now deals 87% to Aragorn.
-Fixed Lurtz sword/carnage weapon miniglitches. Hit FX now also matches damage.
*Lurtz cripple strike Pin now only lasts 12 seconds against Shelob, from 20s. //since this was already loged, this means MordorWitchKing Gandalf last 15 secs from 12s.//before it was affecting Gandalf MordorWitchKing
-Lurtz Cripple strike reload time now 120s, from 100s. //Played with 135s. (Originally 60s)
-Lurtz no longer shares his experience with Wormtongue. 
-Lurtz carnage now deals 90% against Shelob.
-Lurtz Leadership range now 225 from 275. (originally 200)
-Added new Lurtz start Carnage animation. Time to unpack it set to 1000ms. //played with 1100 + paralyze bonus if aborted
-Lurtz cripple strike autoability affecting Bats/crebain fixed.
*Lurtz pillage moved to level 7 from level 6.
-Lurtz carnage now deals 80% to STRUCTURES, from 100%
-Lurtz no longer shares his expereince gains with Saruman.  (Saruman already does not share to Lurtz)
*Lurtz cripple strike Pin now lasts 15s, from 20s
*Lurtz cripple strike damage on flyers now x4 from x3.5. 
#### Heroes. WormtongueGrima
-Fixed Wormtongue Backstab not reading any scalar due damage gains counterweighting the base damage. 
-Wormtongue Backstab can now be casted on MordorBlackRider and MordorWitchKing. (Applies initial knife damage, but no POISON).
-Wormtongue Backstab poisoning damage can now be seen by the player on portrait.
-Wormtongue KNIFE damage now 110/186 from 100/200.
-Wormtongue backstab POISONING total damage now 1500/2103/2534 from 250/1500/2750
-Wormtongue backstab KNIFE initial damage now 380/533/642 from 500/550/600
-Wormtongue backstab KNIFE damage now deals 150% bonus on MordorWitchKing.
-Wormtongue Backstab poisoning damage on MordorFellBeast set to 105% from aproximately 100%.
-Wormtongue Backstab poisoning damage on GoblinDrogoth set to 78% from aproximately 100%.
-Wormtongue Backstab poisoning damage on ElvenFortressEagle set to 47% from aproximately 100%.
-Wormtongue Backstab poisoning damage on SummonedEagle set to 65% from aproximately 100%.
-Wormtongue can now bacstabk while stealthed. yet it will cancel stealth once used.
-Wormtongue respaw cost updated to its actual build cost. (From based on 2000 to based on 1800)
-grima venemous words now affect DwarvenBattleWagon.
-Grima Words debuff radius restored to 140. //played with 150.
-Added new Wormtongue cast Venomous Words animation. Time to unpack it set to 860 ms.
-Wormtongue venomous words speed slow down now-40% from-35%.
-Fixed Wormtongue poisonous words fx not matching with its real duration. 
-Wormtongue poisonous words radius now 150/150 cast radius/radius effect. (from 100/140 respectively)
...
-Fixed Wormtongue poisonous words overwriting crebain effect. Now stacks with it.
#### Heroes. Saruman
-Saruman TrainAllies radius cursor now 110 from 100.
-Saruman TrainAllies actual radius now 110 from 150.
-Saruman fireball fire damage  now deals 65% from 100% against ElvenTreebeard.
-Saruman fireball now deals 120% from 100% against ElvenThranduiil.
-Saruman fireball now deals 200% damage against MACHINES y Wagons.
-Saruman speed now 58 from 60. (Lurtz is 58).
-Saruman experience required for levle 10 reduced to 1900 from 2100.
-Saruman WizardBlast now have a TaperOff of 80%.
-Saruman WizardBlast level 4 extra damage now affects only Infantry, Monsters, Heroes and GoblinSpiderRider. 
-Saruman WizardBlast knockback heroe chances increased to 25% from 15% when level 4. Only applies in 45º arc radius instead of 75º.
-Saruman now indicates his secret Leadership as description (standing cursor on his portrait)
-Saruman health restored to 3000 from 2900. (previously 2800, and 2400 in bt2dc)
-Saruman crushable level now 4 from 2. (Can't be crushed by TomBombadil)
*Saruman can no longer knock down GoblinCaveTroll with his auto attack(spells still do)
-Saruman's Leadership now Stacky Armor Leadership from Generic Hero Leadership. (Now 25% armor 25% experience from 25% damage 25% armor 50% experience).
...
-Fixed GoblinArcher PoisonedArrows having no shoot animation,.
-GoblinArcher Fire arrow damage now 26/25 from 26/20
-GoblinArcher PoisonedArrows now can be set as an autoability. Yet, scan range has been set to half of it's actual range. And also added a min scan range to avoid using it on melee.
#### Units. GoblinMarauder
-GoblinMarauder pike damage now deals 75% against DwarvenBattleWagon, from 100%.
-GoblinMarauder pike damage now deals 75% against IsengardWargRider, from 50%. //Note the splash damage against warg was reduced
*GoblinMarauder pike damage now deals 90% against GoblinCaveTroll, from 100%. //Doesn't include neutral troll.
-GoblinMarauder pike damage now deals 105%/105% against MordorMountainTroll, from 100%/100%.
-GoblinMarauder pike damage now deals 90%/90% against STRUCTURES, from 100%/100%. //Played with 90% against Isen buildings.

-GoblinMarauder attack moving using run animation fixed.

-GoblinMarauder armor now takes 100%/65% FLAME damage, from 100%/70%.
-GoblinMarauder armor now takes 100%/65% MAGIC damage, 100%/70%.
-GoblinMarauder armor now takes 20%/10% CAVALRY damage, from 20%/13%.
-GoblinMarauder armor now takes 10%/5% CRUSH damage, from 10%/6.5%.

-GoblinMarauder splash damage now deals 50% against IsengardWargRider, from 100%. //Note the non-splash damage was increased.
...
#### Units. GoblinCaveTroll
-GoblinCaveTroll buildtime now 35 secs from 36s. 
-GoblinCaveTroll commandpoints now 35 from 30. (Originaly 25)
-GoblinCaveTroll size scale 1.15 from 1.05. 
-GoblinCaveTroll now uses the new MonsterStance, from Artillery.
-GoblinCaveTroll GrabTree/GrabGoblin scan disntace now 600 from 300.
-GoblinCaveTroll GrabTree/GrabGoblin command not working while moving or attacking is now fixed. Scan radius reduced since it's now 100% receptive.
-GoblinCaveTroll ExperienceLevels: experience required increased in all levels (from total experience required to level 10 805 to 1010)
-GoblinCaveTroll ExperienceLevels: damage gains are now multiplicative (+5% more damage per level). This means the damage gains for ClubSwingAttack weapons are no longer design breaking. (For example: with additive damage, a lvl 10 GoblinCaveTroll had exactly +50% more damage for PunchAttack and ShoulderAttack, but ClubSwingAttack/bash with tree would have +200% more damage. Breaking whatever scalars one carefuly makes for early game)
-GoblinCaveTroll ExperienceLevels: health gains lvl 2-5 reduced by 20%, levels 5-10 significantly increased. (Total hp gained now 1255 from 1000)

-GoblinCaveTroll hitreaction animations: the longest one now play by a high priority attack, from a normal one. (The larger hit reaction plays by a stronger attack)
-GoblinCaveTroll hitreaction threshold damage now >25/>75/200 from >0/>50>200. (Reduces the chances of playing hit reactions while fighting swordmen or cavalry)


-GoblinCaveTroll speed to 58 from 57. played with 59 onbeta.
*GoblinCaveTroll speed is now increased +2% at level 2, then +4% at level 5, and +6% at level 7. 
...
-GoblinCaveTroll armor to HEROES 25% of self improvement at level 5 removed.


-GoblinCaveTroll AutoHeal now begins in level 2 healing 27 HP per second, then in level 5 it heals 40 HP per second. (From 40 hp per second in level 3 and gaining +3 in levels 5 6 7 8 9 10)
-GoblinCaveTroll AutoHeal level can now be told by portrait tooltip (Basic on lvl 2 & Advanced in level 5).
...
-GoblinCaveTroll PunchAttack against MACHINES now 125% from 100%. 
-GoblinCaveTroll PunchAttack max/min damage now 220/160, from 200/200.
-GoblinCaveTroll PunchAttack now deals -10% damage against PIKEMEN. (Note i increased base damage)
-GoblinCaveTroll PunchAttack now freezes him for 400 milliseconds in order to prevent hit and move glitch.
-GoblinCaveTroll PunchAttack set a taperoff of 80%. 
-GoblinFaction GoblinCaveTroll PunchAttack scalars against PIKEMEN are now same as with Tree. (87% ANY +Phalanx,82% ANY +GondorTowerShieldGuard,95% ANY +MordorEasterling, 110% ANY +IsengardPikeman)
...
-GoblinCaveTroll PunchAttack now has the Atack Troll bonuses against heroes. (115% general, 130% Aragorn DwarvenGimli Elrond, 125% Gandalf, ElvenGlorfindel, 160% Eowyn Eomer). (From 105% against any heroe, respectively)
-GoblinCaveTroll indirect PunchAttack damage over STRUCTURES now deal half damage of ShoulderAttack.
-GoblinCaveTroll PunchAttack not attacking automatically fixed.
-GoblinCaveTroll PunchAttack now freezes him for 500 milliseconds in order to prevent hit and move glitch.


-GoblinCaveTroll ClubSwingAttack max/min damage now 140/108.
-GoblinCaveTroll ClubSwingAttack damage now deals 187% against MACHINES, from 100%.
-GoblinCaveTroll ClubSwingAttack damage now deals 187% against DwarvenBattleWagon, from 100%.
-GoblinCaveTroll ClubSwingAttack damage now deals 120% against CAVALRY, from 100%.
-GoblinCaveTroll ClubSwingAttack damage now deals -10% against PIKEMEN.
-GoblinCaveTroll ClubSwingAttack DamageArc/MetaImpactArc now 80/80 from 90/90.
-GoblinCaveTroll ClubSwingAttack DamageRadius/MetaImpactRadius now 60/60 from 55/50 respectively.
-GoblinCaveTroll ClubSwingAttack damage now deals 50% against STRUCTURES, from 100%. (this is only dealed indirectly, vs buildings they use Shoulder).
-GoblinCaveTroll ClubSwingAttack chances to knockback a heroe now 66% from 100%. //Does not apply against Boromir.
-GoblinCaveTroll ClubSwingAttack now has the Atack Troll bonuses against heroes. (115% general, 130% Aragorn DwarvenGimli Elrond, 125% Gandalf, ElvenGlorfindel, 160% Eowyn Eomer). (From 100% against any heroe, respectively)
-GoblinCaveTroll ClubSwingAttack not attacking automatically fixed.
-GoblinCaveTroll ClubSwingAttack now freezes him for 500 milliseconds in order to prevent hit and move glitch.
...
-GoblinCaveTroll GoblinThrow range now 450 from 500.
-GoblinCaveTroll GoblinThrow 50% penalty against STRUCTURES now only affect Fortress.
-GoblinCaveTroll GoblinThrow no longer affect allied STRUCTURES.
-GoblinCaveTroll GoblinThrow now deals 300% against Towers, from 50%. (in case it does not one-hit them) // played with 200%.
...
-GoblinCaveTroll ShoulderAttack -10 on IsengardFurnace


-GoblinCaveTroll RockThrow radius of daamge now 15 from 12. Added a damage taperoff of 65%.
-GoblinCaveTroll RockThrow now deals 200% against MACHINES, including DwarvenBattleWagon.
-GoblinCaveTroll RockThrow no longer affect allied STRUCTURES.
#### Units. GoblinMountainGiant
...
-GoblinFaction GoblinFireDrake now have a crush weapon of 400 damage. (MordorMumakil are 800 and Shelob is 200). //No longer one hits everything.
...
-GoblinFortress Razor spines can now heal Shelob.
...
-GoblinKing MinCrushVelocityPercent and DecelerationPercent now 50%/15% from 50%/30%. (For comparison all mounted heroes except MordorBlackRider are 50%/30%, MordorBlackRider is 56%/5%, ElvenThranduil elk is 40%/10%, Shelob is 75%/7%.)
-GoblinKing now takes 77.7% from CRUSH_REVENGE, from 100%. //Just like Shelob
...
-GoblinKing Stinger POISON duration now 30 from 25. Total damage dealt now 2400 from 2000. Originally 3000. //For comparison, Shelob Stinger total damage is 6000. Originally 9000.
-GoblinKing Stinger POISON now also deals 80% against Saruman.
...
-GoblinKing Stinger reload time now 80 secs from 60 secs. Same as Shelob.
-GoblinKing Stinger initial damage now matches with his normal sword damage. 
-GoblinKing Stinger now deal 80% against DwarvenGimli. (from dealing 80% only on Saruman... it's the same armor)
#### Heroes. Shelob
-Shelob Screech hit and run glitchy thing fixed.
-Shelob Screech unpacking time now 200 ms from 100 ms.
-Shelob can now cast Stinger on flyers. Damage scalars set to 30% than Grima. (consider Shelob Stinger damage is a lot higher)
-Shelob Stinger initial damage set to Hero from SLASH.
-Shelob Stinger (initial damage, not POISON) now deal a 150% from 100% against MordorWitchKing.
-Shelob Stinger now deal 80% against DwarvenGimli. (from dealing 80% only on Saruman... it's the same armor)
-Shelob Stinger can now be casted on DwarvenBattleWagon. Tho POISON damage will not be dealt.
-Shelob Stinger new's extra speed stun now (-50%). //Played with (-95%).
-Shelob  Stinger new's extra speed stun now lasts 15 seconds. //played with 10seconds.
-Shelob Stinger new's extra speed stun now affects not only heroes but also monsters or any poisonable unit.
-Shelob can now cast Stinger on monsters, MordorWitchKing and ring heroes. But only poisonable units will be damaged by POISON and slowed down.
-Shelob Stinger damage gains are now multiplicative. Level6 to level 10 respectively now 200/227 from 200/200. (Originally 300/300) (Total damage 6000/7029 from 6000/6000) (Originally 9000/9000)
-Shelob Stinger initial HERO damage re-added. Casting Stinger deals the damage of one normal attack.
-Shelob Stinger paralyze for 6 seconds but after that, heroe speed will be reduced to 5% for 4 more seconds. (Originally 15 secs of paralyze)
-Shelob Stinger poisoning now deals 120% against Elven melee heroes.
*Shelob Stinger can now paralyze MordorWitchKing (but no damage)
-Shelob Stinger POISON now deals 80% against Saruman.
-Shelob WebOfUngoliant reload time now 165 from 200.
-Shelob WebOfUngoliant autoability affecting Bats/crebain fixed.
-Shelob WebOfUngoliant StartAbilityRange now 300 from 400. ShelobWebOfUngoliant projectile range now 530 from 400. //Less chances of starting cooldown and fail.
-Shelob WebOfUngoliant Fxs reworked. Fixed FX detonating at Shelob herself. Removed all POISON fx's reference.
-Shelob WebOfUngoliant ability is now a ArrowStorm style of power instead of a HawkStrike style. Six webs will be shot in bursts of two. Damage and radius rebalanced. Full damage balanced against flyers. 5k heroes won't ever take more than 25% damage in the impossible case a player manages to catch a flyer and ElvenEagles/fellbeast no more than 50%.
-Shelob WebOfUngoliant now drains life only against heroes, monsters and flyers. Creating webbign paralyze FX on them. Flyers cannot be paralyzed. The better healing, the more heroes you need to catch.
-Shelob WebOfUngoliant damage is no longer dealt instantly, instead causes damage for the 4.5 seconds of its stun duration.
-Shelob mandibles now deal 115% from 100% against MordorWitchKing.
-Shelob mandibles now deals 80% against any trolls except MordorMountainTroll.
-Shelob mandibles damage set a taperoff of 65%. No longer killing 6 horses in two hits.
-Shelob mandibles damage now heroes now 100% from 95.3
-Shelob mandibles now deals 80% against RohanRohirrim.
-Shelob mandibles attack animation not matching damage and playing attack FX's before moving sword fixed. PreAttackDelay, DelaybetweenShoots and Firing duration now 700, 600, 466 from 300, 1200, 766 respectively. .
-Shelob mandibles damage now 270 from 300. Damage dealt against STRUCTURES/Heroes now 56%/95%, from 50%/85% respectively. /////This is basicaly a nerf thought against monsters and CAVALRY.
-Shelob mandibles HERO damage gains are now multiplicative. Level1 to level 10 respectively now 270/383 from 300/400. //played with 270/370.
-Shelob can now be healed by friendly wells.
-Shelob armor now takes 50% SPECIALIST, from 45%.
-Shelob health reduced from 4000 to 3750
-Shelob now takes 37% CAVALRY damage, from 25%
-Shelob CRUSH damage gains are now multiplicative. Level1 to level 10 respectively now 210/298 from 200/300.
#### Heroes. Drogoth
...
*GoblinDrogoth damage against Saruman now 40% from 50% (Originally 30%).
...
-Fixed multiple heroes Leadership visualy stacking. 10 Trebeards together, for example, won't cause lag. Elf Statue, Men Statue, Elrond, Sharku, Darkness will no longer visualy stack.
...
-Units that gain AutoHeal by level up now indicate it on portrait. (Any kind of troll, MordorMumakil, berserker, FireDrakers, ElvenEnt, Giants)
...
-AnyFaction Trolls now properly deal the 130% intended damage against DwarvenGimli and Aragorn, instead of 115%.
...
-Boromir, Faramir, Dain TrainAllies no longer freezes the heroe upon trigger. 
...
-Reworked the respawn updates formula of all heroes: If a heroe does not have any ability at level 10 and the damage gains are normal; lvl 8 9 10 take 2.5x/0.725 instead of 3.00x/0.80x. DwarvenGimli, Theoden, Fellbeast, 
-Flyers now deal 50% against MordorMountainTroll.
-Flyers now deal 50% against MordorDrummerTroll.
-ResilientHeroArmor now take 28% CAVALRY damage from 25%. (Currently GandalfMounted MouthOfSauronMounted Sharku ElvenThranduil )
-Gandalf, MordorWitchKing heroes can no longer be crushed by Tom Bombadil (crushable level 4 now 2), while Aragorn, Dain, DwarvenGimli, Saruman stop being crushable by Tom Bombadil once level 5.
-Antiglitch for Saruman, womrontuge, MordorWitchKing, barrowight. (fixed delay between shoots being shorter than firing duration)
-MordorFellBeast, MordorWitchKing & GoblinDrogoth attack now have a 65% chances of knock-back a light heroe, instead of 100%.
-Fixed Aragorn Athelas, Elrond ElvenGrace, Aragorn BladeMaster, ElvenThranduil DeadEye, Lurtz Carnage starting cooldown before the effect. From now on, the cooldown will start only if the abilities and it's effects were properly unpacked.
...
-Fixed Aragorn, Eowyn, MordorMouthOfSauron, ElvenGlorfindel & Lurtz Carnage dealing extra damage over Isengard Warg sentries.
#### Units. Hordes
...
-Guardian, Phalanx, MordorCorsair, EasterSpiderLingLairs, ElvenMithlondSentry, IsengardFighter, IsengardPikeman, Lorien Warriors, GondorSoldier time before figure out they are being flanked reduced. (Flanked delay to 500 from 2000)
...
#### Spellbook. TaintedLand:
-TaintedLand size reverted to 250, from 225.
#### Spellbook. RallyingCall
...
-Sam firecracker now deals 550% from 700% against Shelob. (650% would be proportional to the HP nerf)
#### Spellbook. SummonWildmen
...
-Hotkeys: GoblinArcher PoisonedArrows: Now (T) from (P).
-Hotkeys: GoblinFighter PoisonedArrows: Now (W) from (P). (all langs)
-Hotkeys: MenOfDale BlackArrows hotkey from K to T.
...
-Edited BFME2's GoodErebor campaign: inns can now properly make MenOfDale archers as originaly designed.
-Edited BFME2's GoodCeldium: inns can now properly make MenOfDale archers as originaly designed.
...
#### Removed.Maps
-Removed BFME1'S BlackGate version
-Removed BFME1'S gap of rohan II
-Removed Ecth's Emyn Arnen Tournament.
...
-Added Gandalf the grey portraits.
...
* **From** means from 1.08. **Originally** means 1.06/2.06. **Restored** implies values from 1.06/2.06.
* **SLASH** means sword damage.
* **PIERCE** means arrow damage.
* **URUK** means damage dealt by Isengard Warriors and Mordor Orc Warriors.
* **SIEGE** means damage from trolls, artillery, machines, and Glorfindel's anti-structure damage.
* **CAVALRY** means cavalry melee damage.
* **SPECIALIST** means damage dealt by pikemen and Haldir's Golden Arrow.
* **CRUSH** means cavalry trample damage.
* **STRUCTURAL** is the damage dealt by arrows/axes from lone towers, barricades, towers, fortresses, etc.
* **CAVALRY_RANGED** is the damage dealt by cavalry units' bows, including Mounted Orcs from Battlewagons. It also includes damage from Volley Arrow.
* **HERO_RANGED**, as the name implies, is the damage dealt by heroes in bow mode.
* **MAGIC** is the damage dealt by most spells. It is also mixed with **PIERCE** for Silverthorn Arrows.
* **FLAME** is used by Fire Arrows and certain spells. Most of the time it is mixed with **MAGIC** (Fireballs, Fire Breath), and with **PIERCE** for Fire Arrows.
* **FlankedPenalty** is the armor penalty applied when a unit gets flanked.
* **Cooldown** means reload time.
* **Experience levels** changes refer to XP required, XP awards, and attributes gained per rank, such as armor, damage, health, etc.
* **Indirect attack** means damage dealt by Mordor Flyers and Eagles when attacking a different kind of target, usually Monsters or Structures.
* **Direct attack** means any Flyer attacking a target intentionally, either automatically or when targeted by the player.
* **One-Hit** means instant kill.
