//------------------------------------------------------------------------------------------------------;;
;;----------------------------------BFME2 1.09v3.0 from 1.09v2.0 Changelog -----------------------------;;
//------------------------------------------------------------------------------------------------------;;
...
* Patch 1.09 — Version 3.0 Changelog
...
## Factions. Men:
### Men. Structures
-Beta61.2: MenOfTheWest: Structures: readded 1.09 models except BlackSmith and Farm.
-Beta61.2: MenOfTheWest: Structures: men vanilla buildings to be forced to high model.
-Beta61.1: MenOfTheWest: Structures: Models reverted to vanilla by popular request.
...
#### GondorFarm
-Beta61.2: MenOfTheWest: Structures.Farm: fixed gondorfarm redbug in old models. (new one was already fine)
...
-Beta01: MenOfTheWest: Structures.Farms.Farm.Armor.FarmArmorStandarization:ICAL_FIRE damage taken now 4%, from 6%. //Note this farm originally had a Flammability behavior, which were Reverted during BTP.
...
-Beta01: MenOfTheWest: Structures.Barracks.Barrack: BasicTraining techny buildcost now 10 secs from 5. (others are 10)
#### GondorWalls
...
-Beta61.2: MenOfTheWest: Structures.Fortress.BoilingOil: range reduced to 200 from 250. Max/Min damage set to 1200/360 from 1200/450 (Originally 600/600)
...
-Beta61.1: MenOfTheWest: Units.TowerGuard: can no longer be trampled during porcupine stance, just like any other porcupind pikeman in the game.  //MiraakOCD//
-Beta01: MenOfTheWest: Units.TowerGuard: level 8, 9 and 10 not gaining any modifier, fixed.
#### Units. RohanElvenWarriorFromInn
...
-Beta60.5: MenOfTheWest: Units.GondorArcher: Now pays BasicTraining for 120, instead of 200. //played with 150.
-Beta60.1: MenOfTheWest: Units.GondorArcher: damage against GoblinSpiderling 115% from 125%. (Basicaly we keeping beta60 relationship for Men)
-Beta60: MenOfTheWest: Units.GondorArcher: EarlyBuffLateNerf. experience required for level 2 now 45 from 50 (Originally 50, was 30 in bt2dc, 35 in 1.09v1)
-Beta60: MenOfTheWest: Units.GondorArcher: EarlyBuffLateNerf. experience required for level 5 now 225 from 170. (Basic infantry is 250)
-Beta60: MenOfTheWest: Units.GondorArcher: EarlyBuffLateNerf. experience required for level 10 now 495 from 470. (Basic infantry is 550
-Beta60: MenOfTheWest: Units.GondorArcher: EarlyBuffLateNerf. damage gains at even/uneven ranks now +3/+7 instead of +7/+3. (Total dmg in lvl10 now 73 from 75. //played with 77)
-Beta47: MenOfTheWest: Units.GondorArcher: FireArrows PIERCE gains +35%, from +15%. (Originally +0%)
-Beta42: MenOfTheWest: Units.GondorArcher: now pays HeavyArmor for 200, instead of 300.
-Beta42: MenOfTheWest: Units.GondorArcher: now pays FireArrows for 200, instead of 300.
#### Units. GondorSoldier
...
-Beta61.2: MenOfTheWest: Units.Soldier: ShieldBlock formation is now slightly wider, which means less vulnerable to splash damages.
...
#### Units. RohanRohirrim
-Beta61.2: MenOfTheWest: Units.Rohirrim: Damage gains are now multiplicative. Set to +6% per level (which means 169% dmg in level 10).  Min/Max pierce damage now 35/59 from 29/85. Min/Max flame now 20/31 from 25/25. Min/Max cavalry melee now 80/135 from 80/136). Crush damage is not affected, consistently with normal cavalry, thanks a creative code i sorted out.
-Beta61.2: MenOfTheWest: Units.Rohirrim: Bow (without fire) is now 20% stronger against infantry(excluding archer and pikes)
-Beta61.2: MenOfTheWest: Units.Rohirrim: Bow damage portrait is now trully representative. (Althought it can still not represent the upgrade with fire arrows)
...
#### Units. Trebuchet
-Beta61.1: MenOfTheWest: Artillery.Trebuchet: GondorTrebuchet can now display the upgraded damage in portrait.
...
#### Heroes. Eomer
-Beta58: MenOfTheWest: Heroes.Eomer: BountyValues. Eomer Outlau leadership bounty values set to 85%, from 100%. (Consider bounty values are usually 25% for level 1 units, and 50% for level10 units)
#### Heroes. Eowyn
...
-Beta60.9: MenOfTheWest: Heroes.Eowyn.Armor: When mounted, now takes 77.7% crush revenge, from 100%. (Same than Sharku)
-Beta48: MenOfTheWest: Heroes.Eowyn.Armor: When mounted, now use ResilientHeroArmorMounted, from MountedHeroArmor; which makes her mounted armor against pikes superior.
-Beta61.1: MenOfTheWest: Heroes.Eowyn.Smite: 445 from 515
-Beta60: MenOfTheWest: Heroes.Eowyn.Smite: smite damage against fellbeasts at level 1/4/7 now 400%/430%/460% from 391%/435%/470% respectively.
-Beta60: MenOfTheWest: Heroes.Eowyn.Smite: smite damage against heroes at level 1/4/7 now 130%/145%/160% from 135%/150%/165% respectively.
-Beta56: MenOfTheWest: Heroes.Eowyn.Smite: smite damage radius at lvl1/4/7 now 14/16/18 from 12/15/18. (less shitty at lvl1)
-Beta54: MenOfTheWest: Heroes.Eowyn.Smite: Smite; Now stuns Heroes for 1 second at level 4, and 2 seconds at level 7. Existing bonuses against Heroes and monsters are now 10% weaker between level 1-4, but 10% stronger between levels 7-10. Radius is also 20% smaller at levels 1-4, but 20% bigger at levels 7-10. Set a taperoff of 65%. Reload time set to 100 seconds, from 135.
-Beta54: MenOfTheWest: Heroes.Eowyn.Disguise: Disguise is no longer a state, but a temporary ability. Set a duration of 30 seconds and a reload time of 80 seconds. Effect is no longer canceled by stealth detectors. Disguise can now be used on foot.
-Beta60.9: MenOfTheWest: Heroes.Eowyn.Disguise: Disguise now provides the deceleration rate and minimun crush speed of a Rohirrim. (decelerates 15% instead of 30%)
-Beta54: MenOfTheWest: Heroes.Eowyn.Disguise: Disguised damage now deals 72% damage against Structures, from 36% (Originally 100%). //Same as standard melee mode.
-Beta60: MenOfTheWest: Heroes.Eowyn.Disguise: Disguised damage now deals 125% damage against Heroes, from 50% (Originally 100%). //Played with 135% in Beta54
-Beta58: MenOfTheWest: Heroes.Eowyn.Disguise: unpack disguise time now 750 ms from 1250 ms.
...
-Beta49: MenOfTheWest: Heroes.Eowyn.ShieldMaiden: ShieldMaiden sound now only plays when properly executed.
-Beta54: MenOfTheWest: Heroes.Eowyn.ShieldMaiden: ShieldMaiden mow provides another +35% extra armor against HERO and HERO_RANGED damage types. Also provides 50% less deceleration when trampling. Reload time remains being 120 seconds.
#### Heroes. GondorBoromir
...
-Beta48: MenOfTheWest: Heroes.Gandalf: mounted now uses the new ResilientHeroArmorMounted armor, which is generaly weaker against fire, magic, pikes, structural even cavalry. (More info in Heroes)
...
#### Spellbook. SummonArmyOfDead
-Beta61.2: MenOfTheWest: Units.OathBreakers: Fixed oathbreakers not causing magic crush damage over Aragorn.
-Beta01: MenOfTheWest: SpellBook.SummonArmyOfDead: SummonArmyOfDead not castable in areas with deep water, fixed.
#### Spellbook. SummonRohirrims
...
-Beta01: Elves: Structures.Farms.Mallorn.Armor.FarmArmorStandarization:ICAL_FIRE damage taken now 4%, from 0.75%.  //Note this farm originally had a Flammability behavior, which were Reverted during BTP.
...
#### Structures. ElvenEregionForge
-Beta54: Elves: Structures.Forges.EregionForge: ElvenHeavyArmor now costs 300 from 350.
; -Beta60.7: //RevertedThis// -Beta01: Elves: Structures.Forges.EregionForge: Elven BasicTraining techny build time now 10 secs from 15.
...
#### Structures. ElvenFortress
-Beta61.2: Elves: Structures.Fortress.CrystalMoat: buildtime now 20 from 25. (originally 30)
...
### Elves. Units.
-Beta61.1: Elves: Units.Infantry: BannerCarriers can no longer heal while fighting. Heal amount set to 7 from 3. (other factions are 10)
#### Units. RohanPeasantFromInn
...
#### Units. Lorien-ElvenLorienArcher
...
-Beta61.2: Elves: Units.ELvenWarrior: now deals 95% against GondorSoldier, from 100%. (Ugly but consider similar scalars were done with urukhai against guardians [92% vs guardian]) //Compensates shieldwall dmg nerf
-Beta59: Elves: Units.LorienWarrior: flanked duration now 3000 from 4000. //Played with 2500
...
#### Units. RivendellLancer
-Beta61.2: Elves: Units.RivendellLancer.BannerCarrier: banner carrier having different locomotor than a normal lancer, fixed.  //MiraakOCD//
...
-Beta01: Elves: Units.RivendellLancer: lance now deals +15% against AxeThrower.
...
#### Heroes. ElvenLegolas
-Beta60.8: Elves: Heroes.Legolas: Buildtime now 50 from 45.
...
-Beta48: Elves: Heroes.Thranduil.Armor: mounted now uses the new ResilientHeroArmorMounted armor, which is generaly weaker against fire, magic, pikes, structural even cavalry. (More info in Heroes)
#### ElvenGaladriel
...
-Beta61.1: Elves: Heroes.Galadriel: HealingSpell no longer heals 5% per burst (20 bursts), now heals 150 healthpoint on each one.
#### ElvenEagle
...
-Beta01: Dwarves: Structures.Farms.MineShaft.Armor.FarmArmorStandarization:ICAL_FIRE damage taken now 4% from 5%. //Note this farm originally had a Flammability behavior, which were Reverted during BTP.
#### Structures. DwarvenWalls
...
-Beta61.2: Dwarves: Structures.Fortress.HallExpansion: buildtime 10 from 15.
...
-Beta61.2: Dwarves: Structures.Fortress.OilCasks: range increased to 220 from 200. Max/Min damage set to 1200/360 from 1200/450 (Originally 600/600)
...
### Dwarves. Units
#### Units. DwarvenHobbits
-Beta60: Hobbits: rocks now cause a tiny knockback upon infantry death. (like Thranduil DeadEye but smaller)
-Beta35: Hobbits: can now be flanked. Duration set to 1 sec instead of the usual 4 sec.
-Beta01: Hobbits: buildtime now 32 from 30.
-Beta55: Hobbits: commandpoints on ToolTip/actual expent are now 45, from 40 in ToolTip but expending 36.
-Beta55: Hobbits: All hobbit rocks now deal 75% damage against Heroes and infantry, from 50%. Monsters and archers are not included and they still 50%. (Originally 25%).
#### Units. MenOfDale
-Beta60.4: MenOfDale: buildcost 400 from 450. // So undy stops spaming me
-Beta60.1: MenOfDale.Armor: SLASH damage taken now 135%/75% from 150%/75%.
-Beta60.1: MenOfDale.Armor: URUK damage taken now 90%/50% from 100%/50%.
...
-Beta56: MenOfDale.GlobalFireArrowSystem: FLAME damage per horde restored to v2 values (520 from 570).
-Beta55: MenOfDale: horde no longer uses amoeba thing.
-Beta55: MenOfDale: BlackArrows now behave like poison arrows; targets can't escape from it and projectiles will chase it. (LeechRangeWeapon could also be added for Hawkstrike and CrippleStrike if ever required)
-Beta54: Undermine: bonus against Orcs to not include orcarcher.
-Beta54: MenOfDale: BlackArrows can now terrorize Ent and Mumakils, without permanently buging them.
-Beta54: MenOfDale: now pays HeavyArmor for 200, instead of 250. (Originally 300)
-Beta54: MenOfDale: BlackArrows affecting Mumakil fixed. (not meant to cause terror as it bugs mumakils making them permanently mad, which makes them walk faster. Note it affected muma because it was affecting the contained haradrims.)
-Beta54: MenOfDale: BlackArrows damage against Heroes can now be increased leveling up. (A LVL10 MenOfDale would have 165 damage instead of 100)
-Beta54: MenOfDale: BlackArrows damage against all flyers, except ElvenEagles, now 60%, from 50%.  //AndyAutistRequests//
-Beta54: MenOfDale: damage now 57 from 52. (Average between vanilla MenOfDale and haradrim archer).  //AndyAutistRequests//
-Beta35: MenOfDale: can now be flanked. Duration set to 1 sec instead of the usual 4 sec.
-Beta47: MenOfDale: damage gains reduced; total damage gains at level 10 are now +100%, from +120.
-Beta46: MenOfDale: range slightly increased to 390, from 380. range. (same as haradrim archer) //AndyAutistRequests//
-Beta47: MenOfDale: FireArrows PIERCE gains +35%, from +15%. (Originally +0%)
-Beta47: MenOfDale: FireArrows also improve black arrow damage by 35%.
-Beta37: MenOfDale: FireArrows upgrade cost 200 from 300. //plyed with 250
-Beta46: MenOfDale: BlackArrows reload 90 sec from 60sec.
-Beta46: MenOfDale: now pays BasicTraining for 150, instead of 200. (Originally 250.
#### Units. Phalanx
-Beta60.1: Phalanx: attackrange now 32 from 30. (Towerguard/IsenPikeman are 35)
#### Units. Guardian
-Beta61.2: Guardian: now deals 80% against ElvenMallorn, from 90%.
-Beta01: Guardian: axe now deals 100%/120%, from 100%/150% against Berserker.
-Beta60: Guardian: damage against MordorWarrior now deals 100% from 90%. //Played with 95% in beta31
-Beta40.2: Guardian: with forged blades / or siege hammers no longer change command set. Can now be upgraded at same time. Whatever appaers on the icon it will work without any bug, scam or abuse. If forged blade purchased, hammer turns grey. If hammer purchased, blades grey. But icon still appaers for multiselection.
-Beta42: Guardian: siege hammer weapon typo, fixed. (inner issue.)
-Beta27: Guardian: charge can now be applied in multiple selected hordes at same time.
-Beta39: Guardian: Reverted this change from v2. "-Guardian now deals 95%, from 100% against GondorSoldier, Gondor GondorTowerGuard, MordorCorsair, MordorEasterling."
#### Units. AxeThrower
-Beta60.1: AxeThrower: total damage in level 10 now x2.625, from x2.71. //Played with x2.95
-Beta39: AxeThrower: now deals 120% against GondorSoldier, from 100%. (v2 added 20% bonus vs other swormdne)
-Beta48: AxeThrower: vision/shroud range 370/400 from 250/350 respectively.
#### Units. BattleWagon
-Beta61.3: BattleWagon: Spawn animation speed up by +50%. Set to 4.46 from 6.7 seconds. Invulnerable time 3.67 from 5.5 seconds. Build time 32 from 30 seconds.   //MiraakOCD//
-Beta61.1: BattleWagon: wagons not being able to chase single units/monsters, fixed.  //MiraakOCD//
-Beta40.2: BattleWagon: upgraded no longer change command set. Can now be upgraded at same time. Whatever appaers on the icon it will work without any bug, scam or abuse. The purchased upgrade remains colored with the description about what it does and the others turn grey.
-Beta60: BattleWagon: MenOfDale damage against flyers 75% from 100%. (Since they do shot properly now, they pwn.)
-Beta55: BattleWagon: spawn passenger FX being played multiple times and causing lag, fixed.
-Beta55: BattleWagon: randomly deciding to not fight in melee while receiving damage, fixed. Attack range now 25 from 0.
-Beta43: BattleWagon: can now purchase HeavyArmor when player researches the forgeworks techny.
-Beta53: BattleWagon: HeavyArmor will provide exact the same multipliers than WargRider HeavyArmor, but improvements will be 30% weaker. (Means HeavyArmor is generally 35% stronger)
-Beta52: BattleWagon: HeavyArmor cost set to 275. //played with 250 and 300to cost 275 instead of 250.
; -Beta53: //RevertedThis// -Beta43: BattleWagon: HeavyArmor now make them 35% stronger. But its counters multiply by 1.2 or 0.8, like other HeavyArmor do. They become extra 20% stronger against Structural. and 70% extra againstICAL_FIRE.
; -Beta53: //RevertedThis// -Beta43: BattleWagon: HeavyArmor reduces damage taken by 25% for all damage types except MAGIC and FLAME which are reduced by 50% less.
; -Beta42: //RevertedThis// -Beta01: BattleWagon: now receive Mithril Mail when player researches the forgeworks techny. Reduces damage taken by 25% for all damage types except MAGIC and FLAME which are reduced by 50% less.

-Beta61.4: BattleWagon.Armor:ICAL_FIRE damage taken now 30%, from 10%. //played with 40%.//played with 20%.
-Beta51: BattleWagon: model and passengers get a HeavyArmor model.
-Beta53: BattleWagon.Armor: CRUSH damage taken now 60%, from 50%.
-Beta53: BattleWagon.Armor: PIERCE damage taken now 18%, from 15%.
-Beta53: BattleWagon.Armor: MAGIC damage taken now 90%, from 75%.
-Beta53: BattleWagon.Armor: FLAME damage taken now 90%, from 75%.
-Beta53: BattleWagon.Armor: STRUCTURAL damage taken now 220%, from 190%. //played with 200%
-Beta53: BattleWagon.Armor: SPECIALIST damage taken now 220%, from 200%. (Note, 236% would be exact number we would need to have 1.06 CRUSH_REVENGE, in combination with current 53.5% CRUSH_REVENGE damage taken)
-Beta01: BattleWagon: CRUSH_REVENGE damage taken now 53.5%, from 45%.//tested with 47% and 50%. //Also created a test map to isolate every posible variable; CRUSH_REVENGE to look like 1.09v1 should be "63%". So the average between 63 and 45% is 53.5%. *perfection*//this is asuming specialist is 200%.
-Beta53: BattleWagon.Armor:ICAL_FIRE damage taken now 40%, from 10%. //played with 20%.
-Beta49: BattleWagon: animations improved. (-flying-fear-idles states.-hit reactions-level up-raising flag-selected)
-Beta42: BattleWagon: health gains reduced to +1300 from +1500. (health base 3000)
-Beta01: BattleWagon: fast moving turn radius 28 from 24.
-Beta01: BattleWagon: slow moving turn radius 20 from 24.
-Beta01: BattleWagon: crushing units while spawning on the forgeworks, fixed.
##### BattleWagon. MenOfDaleUpgrade
-Beta27: BattleWagon.MenOfDaleUpgrade: not properly shooting while moving, fixed.
##### BattleWagon. AxeThrowerUpgrade
-Beta27: BattleWagon.AxeThrowerUpgrade: not properly shooting while moving, fixed.
##### BattleWagon. BannerUpgrade
-Beta40.1: BattleWagon.BannerUpgrade: cost 350 from 300
-Beta55: BattleWagon.BannerUpgrade: now display a little fx similar to statues. Fx shows only in low or above levels of detail. And it's pretty optimized to don't lag.
-Beta27: BattleWagon.BannerUpgrade: Phalanx attacking inside GoblinTunnel, fixed..//New type of bugfix for all axethrowers & MenOfDale.
-Beta56: BattleWagon.BannerUpgrade: Phalanx max/min damage now 80/65 from 90/75. //played for a long time with 85/75
-Beta01: BattleWagon.BannerUpgrade: Phalanx damage 85 from 90. (09v1 was 75)
##### BattleWagon. WagonHearth
-Beta55: BattleWagon.HearthUpgrade: now display a little fx similar to wells. Fx shows only in low or above levels of detail. And it's pretty optimized to don't lag.
-Beta55: BattleWagon.HearthUpgrade: radius 130 from 160. (v1 was 100)
-Beta54: BattleWagon.HearthUpgrade: can no longer heal while taking damage. (hypotetically)
-Beta54: BattleWagon.HearthUpgrade: heal FX is now a basic nugget, instead of particles + nugget.
#### Units. Demolisher
-Beta61.3: Demolisher: Spawn animation speed up by +50%. Set to 4.4 from 6.6 seconds. Build time 42 from 40 seconds.   //MiraakOCD//
...
-Beta61.3: Catapult: Spawn animation speed up by +50%. Set to 4.6 from 7 seconds. Build time 27 from 25 seconds.   //MiraakOCD//
-Beta61.1: Dwarves: Artillery.Catapult.MinimumAttackRange: DwarvenCatapult can now display the upgraded damage in portrait.
...
-Beta48: Dwarves: Heroes.Dain: mounted now uses the new ResilientHeroArmorMounted armor, which is generaly weaker against fire, magic, pikes, structural even cavalry. (More info in Heroes)
...
-Beta01: Isengard: Structures.Farms.Furnace.Armor.FarmArmorStandarization:ICAL_FIRE damage taken now 4%, from 5%.
...
#### Structures. IsengardArmory
-Beta46: Isengard: Structures.Forges: Armory lvl 3 upgrade buildtime 20s from 25s.
; -Beta60.7: //RevertedThis// -Beta01: Isengard: Structures.Forges: Armory BasicTraining techny build time now 10 secs from 15.
...
-Beta55: Isengard: Structures.Fortress.WizardTower: Tower damageical damage halved (consider the double shots)
...
-Beta61.2: Isengard: Units.UrukWarrior: now deals 95% against GondorSoldier, from 100%. (Ugly but consider similar scalars were done with urukhai against guardians [92% vs guardian]) //Compensates shieldwall dmg nerf
...
; Berserker
-Beta61.1: Isengard: Units.Berserker: Berserker damage taken byICAL_FIRE now 50% from 100%.
...
-Beta01: Isengard: Units.Berserker: experience levels reworked; he gains more health and damage, but awards more. Biggest gains are at level 3 5 7 8 9. Read experience level chang if interested in numbers.
...
-Beta41: Isengard: Heroes.Sharku: being affected by Eomer leadership, fixed.
...
-Beta48: Isengard: Heroes.Sharku: mounted now uses the new ResilientHeroArmorMounted armor, which is generaly weaker against fire, magic, pikes, structural even cavalry. (More info in Heroes)
#### Heroes. Saruman
-Beta39a2: Isengard: Heroes.Saruman: FireballICAL_FIRE damage now has a taper off of 66%.
...
-Beta39a2: Isengard: Heroes.Saruman: FireballICAL_FIRE readded partially. Saruman fireball in level 5 now looks like 1.06; double fireball, doubleICAL_FIRE. (not so op)
...
-Beta01: Mordor: Structures.Farms.SlaughterHouse.Armor.FarmArmorStandarization:ICAL_FIRE damage taken now 4%, from 5%.
...
-Beta01: Mordor: Structures.Barracks: BasicTraining techny buildtime now 10 secs from 20.
; -Beta36: //RevertedThis// -Beta27: Mordor: Structures.Barracks: BasicTraining techny is now available in level 1 orcpit.
; -Beta36: //RevertedThis// -Beta35: Mordor: Structures.Barracks: BasicTraining techny upgrade cost 400 from 300.
#### Structures. MordorTavern
-Beta01: Mordor: Structures.Barracks: MordorTavern lvl3 buidtime now 20 from 25.
-Beta01: Mordor: Structures.Barracks: MordorHeavyArmor techny buildtime now 20 secs from 30.
#### Structures. MordorWalls
...
-Beta61.2: Mordor: Structures.Fortress.LavaMoat: buildtime now 20 from 25. (originally 30)
-Beta61.2: Mordor: Structures.Fortress.MagmaCaldrons: range increased to 240 from 250. Max/Min damage set to 1200/360 from 1200/450 (Originally 600/600)
...
-Beta38: Mordor: Structures.Fortress.DoomPyres: sound being overriden by val's fx, fixed.
-Beta45: Mordor: Structures.Fortress.GateWatcher: buildtime 22 from 25.
-Beta38: Mordor: Structures.Fortress.MagmaCaldrons: cost 1200 from 1350.
-Beta38: Mordor: Structures.Fortress.MagmaCaldrons: damage max/min now 1200/450, from 900/450. //played with 900/585
-Beta38: Mordor: Structures.Fortress.MagmaCaldrons: build up animation speeded up to 5 seconds, from 6.
#### Structures. MordorGorgorothSpire
...
-Beta61.3: Mordor: Units.HaradrimArcher: MordorHaradrim damage gains are now multiplicative (gains +7% damage per rank)
-Beta61.3: Mordor: Units.HaradrimArcher: Pierce damage at level1/level10 now 64/117 from 64/134.
-Beta61.3: Mordor: Units.HaradrimArcher: Flame damage at level1/level10 35/64 from 50/50.
-Beta61.3: Mordor: Units.HaradrimArcher: Barbed damage at level1/level10 now 35/64 from 20/90.
...
-Beta38: Mordor: Monsters.DrummerTroll: terror range now 140 from 100. (Shelob, Nazguls, MordorBlackRiders are 180)
-Beta40.1: Mordor: Monsters.Drummertroll: now takes 50% poison from 25%; (all other trolls take 100%)
#### Units. MordorMountainTroll
-Beta61.1: Mordor: Monsters.MountainTroll.Armor: damage taken by SPECIALIST now 129% from 123%.
...
-Beta61.1: Mordor: Monsters.MountainTroll: autoheal at lvl2-lvl5 reduced by 25%. (They heal faster than cavetrolls despite having their own method to insta heal by eating orcs)
#### Units. MordorAttackTroll
-Beta61.1: Mordor: Monsters.AttackTroll: damage against structures now 250 from 200. //Played with 225. //Originally 400
-Beta61.1: Mordor: Monsters.AttackTroll: can now autoheal at level 1 but very slowly. 10hp per second and only after 15 seconds of idle. (Normal autoheal is at level 3, which heals 50hp after 10 sec of idle)
...
-Beta43: Mordor: Monsters.AttackTroll: Can now purchase HeavyArmor, if player has researched the techny in the Tavern.
-Beta52: Mordor: Monsters.AttackTroll: HeavyArmor cost set to 350. Played with 200, 250.
-Beta49: Mordor: Monsters.AttackTroll: HeavyArmor now make them 35% stronger. But its counters multiply by 1.2 or 0.8, like other HeavyArmor do. They become extra 20% stronger against Structural. and 70% extra againstICAL_FIRE. //played with 35% and 25% basic armor.
-Beta50: Mordor: Monsters.AttackTroll: New troll loyalty icon
-Beta49: Mordor: Monsters.AttackTroll: Now take 30%ICAL_FIRE from 25%.
...
#### Units. MordorCatapult
-Beta61.3: Mordor: Units.Catapult: Mordor catapult speed up by +100%. Set to 8 from 16 seconds. Build time 28 from 20 seconds.  //MiraakOCD//
...
#### Units. Grond
-Beta61.2: Mordor: Artillery.Grond: grond damage reduced to 9300 from 10000. (Leaves a fortress alive after the 2nd hit, but a hit from anything can finish it down.)
-Beta61.2: Mordor: Artillery.Grond: grond commandpoints now 80 from 40.
...
-Beta48: Mordor: Heroes.MouthOfSauron.Armor: mounted now uses the new ResilientHeroArmorMounted armor, which is generaly weaker against fire, magic, pikes, structural even cavalry. (More info in Heroes)
#### Heroes. Fellbeast
...
-Beta38: Mordor: Heroes.WitchKingOnFellbeast: is no longer inmune to poison.  Shelob/Gorkil stinger not so strong tho.
...
-Beta60.3: Mordor: Heroes.WitchKing: Can now use the MorgulBlade ability. Hotkey set to V to avoid conflict with Screech.
...
-Beta55: Mordor: Heroes.WitchKing.Armor: Armor now takes 33% CAVALRY, from 29%. // played with 31%. //now same than Shelob.
...
-Beta61.2: Mordor: SpellBook.RainOfFire: Model size scale now x1.50. Now when it is casted, you no longer see the idle object in the air on basic zoom.
...
-Beta01: Goblins: Structures.Farms.Tunel.Armor.FarmArmorStandarization:ICAL_FIRE damage taken now 4%, from 6%.
...
#### Structures. GoblinTreasureTrove
...
; -Beta60.7: //RevertedThis// -Beta01: Goblins: Structures.Forges: TreasureTrove BasicTraining techny build time now 10 secs from 15.
#### Structures. GoblinFortress
-Beta61.2: Goblins: Structures.Fortress.RazorSpines: Razors now also provide -15% speed debuff for 4.5 seconds for the hordes meleeing the fortress. (Harder to escape)
...
-Beta60.3: Goblins: Units.Spiderling: damage against Guardian now 108% from 112%.
...
-Beta61.2: Goblins: Units.SpiderRider: Damage gains are now multiplicative. Set to +5% per level (which means 155% dmg in level 10) Min/Max pierce damage now 50/78 from 41/111. Min/Max flame now 27/42 from 35/35. Min/Max cavalry melee now 120/186 from 120/190). Crush damage is not affected, consistently with normal cavalry, thanks a creative code i sorted out.
-Beta61.2: Goblins: Units.SpiderRider: bow (without fire) is now 20% stronger against infantry(excluding archer and pikes)
-Beta61.2: Goblins: Units.SpiderRider: Bow damage portrait is now trully representative. (Althought it can still not represent the upgrade with fire arrows)
...
-Beta61.1: Goblins: Units.SpiderRider.BannerCarrier: banner carrier having different locomotor than a normal lancer, fixed. (Was allowing banners to climb walls while the other horde members can't)  //MiraakOCD//
...
-Beta42: Goblins: Monsters.CaveTroll: CaveTroll can now purchase HeavyArmor once player has researched the techny in the TreasureTrove.
-Beta49: Goblins: Monsters.CaveTroll: CaveTroll HeavyArmor now make them 35% stronger. But its counters multiply by 1.2 or 0.8, like other HeavyArmor do. They become extra 20% stronger against Structural. and 70% extra againstICAL_FIRE. //Played with 25% and 35% basic armor.
...
-Beta59: Goblins: Monsters.FireDrake: inferno damage arc set to 90º from 60º.ical fire radius reduced to 110 from 210. Fire effects now actually match and kinda respect the cast button.
...
### Goblins. Heroes.
#### Gorkil
-Beta61.2: Goblins: Heroes.Gorkil: Stinger paraltyze duration 4 sec from 5 sec. (shelob remains 5 sec)
-Beta61.2: Goblins: Heroes.Gorkil: Stinger slow down duration 12 sec from 15 sec. (Shelob remains 15)
-Beta61.2: Goblins: Heroes.Gorkil: Stinger reload time 100 sec from 80. (Shelob remains 80)
...
#### Shelob
; -Beta57: //RevertedThis// -Beta01: Goblins: Heroes.Shelob: Shelob now takes 47% SPECIALIST from 50% (09v1 was 45%.). //no longer needed with locomotorfix
-Beta55: Goblins: Heroes.Shelob: Shelob armor against cavalry now 33%, from 37%.
-Beta53: Goblins: Heroes.Shelob: Shelob now takes 25%, from 17% FLAME.//AndyAutistRequests//  //Just design change, people want to see fire killing Shelob.
-Beta01: Goblins: Heroes.Shelob.Tooltips: Shelob stinger ToolTip now mentions the speed debuffs.
-Beta01: Goblins: Heroes.Shelob: Shelob Locomotor improved. (Credits to rotwk 2.02, i stole their settings without tweaking anything.)
-Beta01: Goblins: Heroes.Shelob: Shelob mandibles -20% penalty against RohanRohirrim Reverted. (penalty was added before she had a taperoff or rohirrims health was raised)
#### Drogoth
...
-Beta01: Goblins: Heroes.Drogoth: Drogoth Incinerate damaging behind him, where there's no FX or anyICAL_FIRE, fixed. Damage now matches the fire in a proper 90º radius + beneath him. And it can still kill flyers.
...
#### SpellBook. Crebain_MurderOfCrows
...
-Beta60.5: Global: SpellBook.TomBombadil: Leadership range increased to 225 from 200.
...
-Beta55: Global: SpellBook.HobbitsSummon: Frodo sting now turns blue also near any type of troll and spiders. And now deals 300% damage against any type of spider. (in agresive stance can 2-shoot a summoned spider). damage is still insignificant vs Shelob.
...
-Beta61.4: Global: SpellBook.Watcher: Watcher arms damage against heroes restored to 100%, from 135%.
...
### Global.Heroes
-Beta61.1: Global: Heroes: Fixed mounted heroes (Gorkil-Shelob-Sharku were already good) not being able to chase single units.  //MiraakOCD//
...
-Beta61.2: Global: Heroes.CreteAHeroHeroes: fixed wizard's Light Blast ability having the hotkey unlinked to the button.



### Global. Structures
-Beta60.7: Global: Structures.Forges: Now all BasicTraining research techny upgrade build time set to 5 seconds from 10.
...
-Beta38: Global: Structures.Fortress.HousesOfHealing: can heal monsters, but only 0.05% health per second, instead of the usual 2% or 3% that doesn't stack with autoheal.
...
### Global. Units.
-Beta61.1: Global: Units.Pikemen: Every pikemen on the game is now less likely to be flanked by cavalry. (Flanked duration now 1000ms from 4000ms)
...
-Beta61: Global: Units.Cavalry.BannerCarrier: can now crush like any other horde member; crusher/crushable level now 1/3 from 0/0.
#### Units. Archers
...
## Neutral:
### Neutral. Structres
-Beta57: Creeps: Lairs: At last!!! Fixed level-up treasure-chests not working all the time for hordes. Now you can trust it will level up ur hordes.
-Beta01: Creeps: Lairs.FireDrake: Lair now provides 4 gold chest and 1 experience chest, from 3 and 1 respectively. Level up chest now use the moria model.
-Beta01: Creeps: Lairs.BarrowWight: Lair now provides 2 gold chest and 1 experience chest, from 1 and 1 respectively. Level up chest now use the moria model.)
-Beta39a2: Barracks.ShipWright: not healing ships as intended, fixed (it only heals them when they are attacking, because their own autoheals have prioritty. now both stack)
-Beta39a2: Barracks.ShipWright: healing radius now 250 from 300.
-Beta39a2: Barracks.ShipWright: healing rate now 2%, from 3%.
-Beta39a2: Barracks.SignalFire: not healing Heroes as intended, fixed. (it only heals them when they are attacking, because their own autoheals have prioritty. now both stack)
-Beta39a2: Defensive.SignalFire: healing radius now 250 from 300.
-Beta39a2: Defensive.SignalFire: healing rate now 1%, from 3%.
-Beta01: Defensive.SignalFire: displaying 0% when captured, fixed. (bonus always worked t
-Beta01: Barracks.Inn: no longer recognised as a Economy type of building.
### Neutral. Units
-Beta61.2: Goblins: Monsters.FireDrake: fixed firedrakes from gorkil being better than fortress one.
-Beta61.2: Goblins: Monsters.FireDrake: FireDrake from fortress health/damage now 6200health/869dmg, from 5500health/820dmg
-Beta61.2: Goblins: Monsters.FireDrake: FireDrake from gorkil, now come at level 7 instead of 10. Health now 5600/796, from damage 5600/844
...
## Misc:
### Misc. Maps:
-Beta01: Maps.Added.Temptations: "River Baranduin".
-Beta01: Maps.Added.Temptations: "Ettenmoors II".
-Beta01: Maps.Added.Ecthelions: "Erech 4th Age".
-Beta55: Maps.Added.Ecthelions: "South Road".
-Beta01: Maps.Added.Solas: "Sorrow Isles"
-Beta01: Maps.Added.Solas: "Southfarthing"
-Beta52: Maps.Added.Solas: "Iron Hills 2". Reworked by Ecthelion
-Beta01: Maps.Added.Crusards: "Legends" from BFME2 1.06. Compatibility has been coded both into the patch and into the map. The famous mission map created by Crusard in 2010 and posted in HeavenGames and T3aAge will now appaer as a patch official map, saving you from transfering issues. Map is fully compatible and winable. Several glitchy 1.06 abilities have been fixed using 1.09v2 codes. Also fixed a broke script in the Dwarf Ruins side mission.
-Beta01: Maps.Added.Makos: "Iron Hills IV"
-Beta01: Maps.Added.Makos: "Rhudaur"

-Beta61.1: Maps.Added.Powerkartoffels: "Harrow Dale".
-Beta41: Maps.Added.Powerkartoffels: "Dunland II". A shrinked version of original dunland.
-Beta60.1: Maps.Added.Powerkartoffels: "Mering Stream II".
-Beta01: Maps.Added.Powerkartoffels: "Brandy Hills"
-Beta01: Maps.Added.Powerkartoffels: "Last Bridge"
-Beta01: Maps.Added.Powerkartoffels: "Mirkwood II"
-Beta56: Maps.Added.Powerkartoffels: "Carnen Mire"
-Beta56: Maps.Added.Powerkartoffels: "Enchanted River"
-Beta40.1: Maps.Added.Powerkartoffels: "Mount Doom II"
-Beta28: Maps.Added.Powerkartoffels: "Bamfurlong"
-Beta28: Maps.Added.Powerkartoffels: "Lonely Mountain Slopes"
-Beta46: Maps.Added.Powerkartoffels: "Rhudel Steppe"
-Beta45a1: Maps.Added.Powerkartoffels: "Canyons of Khand". A 7 player map based in GoldenGrove.
-Beta45a1: Maps.Added.Powerkartoffels: "Forlond"
-Beta45a1: Maps.Added.Powerkartoffels: "Beleriand"
-Beta45a1: Maps.Added.Powerkartoffels: "Gardens of Far Harad"
-Beta55: Maps.Added.Powerkartoffels: "Gladden Fields"
-Beta55: Maps.Added.Powerkartoffels: "Carrock"
-Beta60: Maps.Added. Powerkartoffels: "Desert Temple of Khand". A reskin of udun 4p.
-Beta60: Maps.Added. Powerkartoffels: "Ruins of Old Khand". A reskin of udun 6p.
-Beta60.1: Maps.Added.Powerkartoffels: "Moria"
-Beta60.1: Maps.Added.Powerkartoffels: "Numenors Downfall"
-Beta60.1: Maps.Added.Powerkartoffels: "Glanduin Canyon"
-Beta60.1: Maps.Added.Powerkartoffels: "Rhudel Steppe". A reskin of GoldenGrove.
-Beta40: Maps.Added.Powerkartoffels: "Amon Amarth II". A rework of Amon Amarth by Mako.
-Beta52: Maps.Added.Powerkartoffels: "Eastfold II". A rework of Eastfold by Motoma.
-Beta61.1: Maps.Added.Powerkartoffels: "HarrowDale". A request from Gr3ndal. (v5)
-Beta61.1: Maps.Added.Capuchinos: "Tumladen II" a rework from Tumladen, by SilverBane.
-Beta47: Maps.Deleted.BFME1s: "Dunharrow"
-Beta46: Maps.Deleted.Solas: "Morthond Valley". (gameplay sucks but i used to like it back then because it was the only map with amonhen texturing, but now there are way superior maps)
-Beta46: Maps.Deleted.Jokucs: "Tower Hills" (nobody play it, distances between player look boring. map looked good when we didnt have so many maps)
-Beta46: Maps.Deleted.EAs: "Tournament Snow" from Collector Edition pack. ( i used to keep it cuz it was part of the Collector Editions pack, but its garbage)
-Beta46: Maps.Deleted.RotWKs: "Eregion"
-Beta46: Maps.Deleted.108's: "Brandybuck"
-Beta46: Maps.Deleted.SilverBanes: "Trollshaws"
-Beta46: Maps.Deleted.108's: "GoldenGrove"
-Beta01: Maps.Deleted.RotWKs: "Erech"
-Beta01: Maps.Deleted.RotWKs: "Eastfold"
-Beta60: Maps.Deleted.RotWKs: "Amon Amarth"
-Beta45a1: Maps.Updated.SilverBanes: "Chetwood". Fixed ForsakenInn keeping players alive and having wrong description.
-Beta40.1: Maps.Updated.EAs: High Pass". Fixed black camera when staring at hill peaks.
-Beta60.1: Maps.Updated.EAs: "Erebor". Fixed clouds without actually deleting them.
-Beta56: Maps.Updated.Ecthelions: "Eryn Rhun". Updated to v66 from v58.
-Beta60: Maps.Updated.Ecthelions: "Bos Primigenius Taurus The TW". Updated to 571.
-Beta30: Maps.Updated.Ecthelions: "Lebennin IV". Extended and reworked the east flank.
-Beta30: Maps.Updated.Ecthelions: "Lebennin 4p" Changed lighting to bfme1 version.
-Beta52: Maps.Updated.Ecthelions: "WestEmnet". Fixed broken textures
-Beta01: Maps.Updated.Ecthelions: "WestEmnet". Edited, extended to the north and to the south.
-Beta43: Maps.Updated.Ecthelions: "Firien Forest". Fixed crash in rotwk and fixed signalfire not recognised by scripts (ringHeroes spawn it)
-Beta01: Maps.Updated.Temptations: "Firien Dale". Fixed islands being passable, which means a knockbacked heroe into there cannot escape. Slightly extended the buildable area at the sides of the initial positions. Fortress positions more symetric to each other.
-Beta56: Maps.Updated.Temptations: "Fords of Bruinen". Opened a passage in the northeast and southwest cliffs. Created a little corridor around warg lairs. Created a mount with goblin lairs behind player positions.
-Beta28: Maps.Updated.Temptations: "South Hollin". Beautified; added sounds, rocks, shrubs, improved roads, added animals, birds fishes mamars everything, fixed passable cliffs, fixed top left water, improved water in all map, added rocks. Bob Ross would be proud.
-Beta01: Maps.Updated.SilverBanes: "Lune". Added a loading image similar to the map.
-Beta38: Maps.Updated: fixed around 35 maps with Gollum scripts not working or or without farm templates for AI.
-Beta38: Maps.Updated.Jokucs: "Blue Mountains" towerwar updated to 1v2.
### Misc. ForMappers:
-Beta40.2: ForMappers: ElvenGaladriel now has a experience level.
-Beta44: ForMappers: CreteAHero rain of arrows have old icon.
...
-Beta01: ForMappers: IsengardOrcOverseer now has exp level
-Beta01: ForMappers: MordorGothmogWarg now has exp level
-Beta01: ForMappers: IsengardGrima now has exp level.
-Beta01: ForMappers: AragornMountedOathbreaker now has exp level.
-Beta01: ForMappers: DwarvenBattleWagon1 now has exp level.
-Beta01: ForMappers: BattleWagon childs are now friendly with map.ini.
-Beta01: ForMappers: Skeletonwarrior portrait fixed.
-Beta01: ForMappers: Added rohanarcher model.
-Beta01: ForMappers: Added some more placeholder buttons.
-Beta01: ForMappers: Added objectupgrades for GondorAragorn/Gimli. (as in map.ini u cant grant them upgrades.
-Beta01: ForMappers: ExperienceLevels. placeholders are now based on the MordorBlackRider settings.
-Beta01: ForMappers: Added rohan armory exp levels
-Beta01: ForMappers: Rohan statue/well exp levels added. (for select decals)
-Beta01: ForMappers: Fixed half goblin horde not receiving Upgrade_AllFactionUpgrade
-Beta01: ForMappers: Included rohirrimarchers on farsight filter.(bfme1 unit)
-Beta01: ForMappers: Fixed gamedata.ini macros for BattleWagon passengers data, lorien warrior weapons and more.
-Beta01: ForMappers: Fixed FortressCitadels being invisible in worldbuilder and displaying only the faction floor.
